...
from application.reports.parameters.icon_map import STAT_CARD_ICONS, ICON_SVG_STRINGS
from application.reports.parameters.cwe_lookup import CWE_ROOT_CAUSE, CWE_DETAILS
...
class ReportContext(BaseModel):
    ...
    appendix_tables: Dict[str, Dict[str, str]] = Field(default_factory=dict)  # Each entry: {'title': str, 'html': str}
...
class QuarterlyDeepDiveReportGenerator:
    ...
    REPORT_STRUCTURE = {
                ...
                "tables": [
                    {
                        ...
                        "caption": "Table A1. CVEs Included in This Report (Windows-Specific)",
                        "row_click_config": {
                            "enabled": True,
                            "id_column": "cve_id",
                    ...
                    },
                    {
                        ...
                        "caption": "Table A2. CVEs with CVSS scores that are outliers compared to their vulnerability category.",
                        "row_click_config": {
                            "enabled": True,
                            "id_column": "cve_id",
                            "url_template": "https://msrc.microsoft.com/update-guide/vulnerability/{cve_id}",
        ...
        "looped_sections": {
            "section_3_cve_landscape": {
                "id_html": "section-3-landscape-overview",  # Updated for TOC link
                "heading": "Quarterly CVE Landscape: Volume, Severity, and Categorization",
                "section_blurb": "Explore the quarter's CVE landscape, from the volume of new and updated threats to their severity and categorization. Key metrics and charts reveal overall trends in vulnerability reporting and classification.",
                "prompts": {
                    ...
                    "chart_insight_1": "section3_chart_1_insight.j2",  # For new_vs_updated_monthly
                    "chart_insight_2": "section3_chart_2_insight.j2",  # For volume_by_severity_monthly
                    "chart_insight_3": "section3_chart_3_insight.j2",  # For overall_category_distribution_chart
                ...
                "charts": [
                    {
                        ...
                        "caption": "Figure 1. Trend of New vs. Updated CVEs Published Monthly.",
                    ...
                    },
                    {
                        ...
                        "figure_gen_key": "overall_category_distribution_chart",
                        "title": "Overall Vulnerability Category Distribution",
                        "caption": "Figure 3. Distribution of CVEs by Vulnerability Category for the Quarter.",
                        "insight_prompt": "section3_chart_3_insight.j2"
                    }
                ],
                "callouts_config": [
                    {"key_suffix": "1", "position": "right", "style": "info", "title": ""},
                    {"key_suffix": "2", "position": "left", "style": "info", "title": ""},
                    {"key_suffix": "3", "position": "right", "style": "info", "title": ""}
                ],
                "stats_definitions": [
                    {"metric_id": "total_cves", "card_style": "total_cves_card"},
                    {"metric_id": "critical_count", "card_style": "critical_count_card"},
                    {"metric_id": "important_count", "card_style": "important_count_card"},
                    {"metric_id": "critical_high_pct", "card_style": "critical_high_pct_card"},
                    {"metric_id": "top_impact_type", "card_style": "top_impact_type_card"}
                ]
            },
            "section_4_attack_surface": {
                "id_html": "section-4-attack-surface",
                "heading": "Attack Surface Analysis: Exploitability & Access",
                "section_blurb": "Analyze the evolving attack surface by examining vulnerability exploitability, including attack vectors, privilege requirements, user interaction, and overall complexity. Discover how these factors shape the risk profile and highlight common exploitation pathways.",
                "prompts": {
                    ...
                    "chart_insight_1": "section4_chart_1_insight.j2",  # For attack_vectors_by_privileges_chart
                    "chart_insight_2": "section4_chart_2_insight.j2",  # For interaction_vs_complexity_chart
                    "chart_insight_3": "section4_chart_3_insight.j2",  # For overall_attack_vector_dist
                    "chart_insight_4": "section4_chart_4_insight.j2",  # For cat_av_pr_chart
                    "chart_insight_5": "section4_chart_5_insight.j2",  # For cat_ui_ac_chart
                ...
                "charts": [
                    ...
                    },
                    {
                        ...
                        "caption": "Figure 5. Breakdown of Attack Vectors by Privilege Requirements.",
                    ...
                    },
                    {
                        ...
                        "caption": "Figure 6. CVE Count by User Interaction and Attack Complexity.",
                    ...
                    },
                    {
                        ...
                        "title": "Exploitability: Category vs. Attack Vector & Privileges",
                        "caption": "Figure 7. Privilege Requirements for Attack Vectors within each Vulnerability Category.",
                    ...
                    },
                    {
                        ...
                        "title": "Exploitability: Category vs. User Interaction & Complexity",
                        "caption": "Figure 8. Attack Complexity by User Interaction within each Vulnerability Category.",
                ...
                "stats_definitions": [
                    {"metric_id": "network_vector_pct", "card_style": "network_vector_pct_card"},
                    {"metric_id": "adjacent_vector_pct", "card_style": "adjacent_vector_pct_card"},
                    {"metric_id": "local_vector_pct", "card_style": "local_vector_pct_card"},
                    {"metric_id": "physical_vector_pct", "card_style": "physical_vector_pct_card"},
                    {"metric_id": "user_action_req_pct", "card_style": "user_action_req_pct_card"},
                    {"metric_id": "low_privs_required_pct", "card_style": "low_privs_required_pct_card"},
                    {"metric_id": "high_privs_required_pct", "card_style": "high_privs_required_pct_card"},
                    {"metric_id": "low_attack_comp_pct", "card_style": "low_attack_comp_pct_card"},
                    {"metric_id": "high_attack_comp_pct", "card_style": "high_attack_comp_pct_card"},
                    {"metric_id": "worst_case_cves", "card_style": "worst_case_cves_card"},
                    # {"metric_id": "exploited_pct_kev", "card_style": "exploited_pct_kev_card"},
                ]
            },
            "section-5-cvss-weakness": {
                "id_html": "section-5-cvss-weakness",
                "heading": "Deep Dive: CVSS Insights & Prioritization Hotspots",
                "section_blurb": "Gain deeper insights into CVSS scores and their distribution across vulnerability categories, identifying common weaknesses (CWEs) linked to high-risk CVEs. Pinpoint prioritization hotspots by understanding the correlation between CVSS metrics and underlying vulnerability types.",
                "prompts": {
                    ...
                    "chart_insight_1": "section5_chart_1_insight.j2",  # For cvss_score_by_category_chart
                    "chart_insight_2": "section5_chart_2_insight.j2",  # For top_cwe_in_high_risk_cves_chart
                    "chart_insight_3": "section5_chart_3_insight.j2",  # For top_cwe_av_cvss_chart
                ...
                "charts": [
                    {
                        ...
                        "title": "CVSS Score Distribution by Vulnerability Category",
                        "caption": "Figure 9. Box Plots of CVSS Scores per Category.",
                    ...
                    },
                    {
                        ...
                        "title": "CVSS Distribution by Attack Vector for Top CWEs",
                        "caption": "Figure 10. CVSS Distribution by Attack Vector for Top CWEs.",
                ...
                "stats_definitions": [
                    {"metric_id": "median_cvss", "card_style": "median_cvss_card"},
                    {"metric_id": "p90_cvss", "card_style": "p90_cvss_card"},
                    {"metric_id": "highest_cvss", "card_style": "highest_cvss_card"},
                    {"metric_id": "top_cwe_id", "card_style": "top_cwe_id_card"},
                    {"metric_id": "top_3_cwe_coverage_pct", "card_style": "top_3_cwe_coverage_pct_card"},
                    {"metric_id": "memory_safety_vs_logic_bugs_pct", "card_style": "memory_safety_vs_logic_bugs_pct_card"}
                ]
            },
            "section-6-product-timeliness": {
                "id_html": "section-6-product-timeliness",  # Updated for TOC link
                "heading": "Product Impact & Remediation Timeliness",
                "section_blurb": "Assess the impact of vulnerabilities on specific products and the timeliness of remediation, highlighting the most affected software by CVE criticality. Understand patching and disclosure timelines through an analysis of NVD publication delays.",
                "prompts": {
                    ...
                    "chart_insight_1": "section6_chart_1_insight.j2",  # For top_windows_versions_by_criticality_chart
                    "chart_insight_2": "section6_chart_2_insight.j2",  # For days_to_nvd_by_severity_boxplots
                    "section_summary": "section6_summary.j2",
                },
                "charts": [
                    {
                        "id": "top_windows_versions_by_criticality_chart",
                        "data_prep_key": "top_windows_versions_by_criticality_chart",
                        "figure_gen_key": "top_top_windows_versions_by_criticality_chart",
                        "title": "Top Affected Products by CVE Criticality",
                        "caption": "Figure 11. Products with Highest Counts of Critical/High CVEs.",
                    ...
                    },
                    {
                        ...
                        "figure_gen_key": "days_to_nvd_by_severity_boxplots_faceted",
                        "title": "NVD Publication Delay by CVE Severity",
                        "caption": "Figure 12. Days from Vendor Patch to NVD Publication, by Severity.",
                ...
                "stats_definitions": [
                    {"metric_id": "most_affected_product", "card_style": "most_affected_product_card"},
                    {"metric_id": "median_days_to_patch", "card_style": "median_days_to_patch_card"},
                    {"metric_id": "patched_le_7d_pct", "card_style": "patched_le_7d_pct_card"},
                    {"metric_id": "patched_le_30d_pct", "card_style": "patched_le_30d_pct_card"},
                    # {"metric_id": "zero_day_count", "card_style": "zero_day_count_card"},  # no ETL pipeline for this metric yet
                ]
            },
            "section-7-critical-spotlight": {
                "id_html": "section-7-critical-spotlight",  # Updated for TOC link
                "heading": "Spotlight: This Quarter's Most Critical Vulnerabilities",
                "section_blurb": "Spotlight the quarter's most critical vulnerabilities, offering detailed insights and CVSS scores for high-impact threats. Visualizations help uncover distinct patterns and shared characteristics among these significant issues, aiding in a deeper understanding of their nature.",
                "prompts": {
                    ...
                    "chart_insight_1": "section7_chart_1_insight.j2",  # For spotlight_cves_cvss_scores_bar
                    "chart_insight_2": "section7_chart_2_insight.j2",  # For tsne_cve_clusters_plot
                ...
                "charts": [
                    {
                        ...
                        "title": "CVSS Scores of This Quarter's Most Critical CVEs",
                        "caption": "Figure 13. CVSS scores of this quarter's most critical CVEs.",
                    ...
                    },
                    {
                        ...
                        "caption": "Figure 14. t-SNE projection of CVEs showing distinct vulnerability profiles.",
                ...
                "tables": [
                    {
                        ...
                        "caption": "Table S1. Details of Spotlighted Critical Vulnerabilities.",
                        "row_click_config": {
                            "column_name": "CVE ID",
    ...
    LLM_TASK_MODELS = {
        ...
        "chart_insight": "gpt-4o",  # cheap | fast | smart @ $0.40/1M tokens - 1M context window
        "section_summary": "o3-mini",  # expensive | slow | very smart @ $1.10/1M tokens - 200K context window
        "executive_summary": "o3-mini",  # expensive | slow | very smart @ $1.10/1M tokens - 200K context window
        "report_conclusion": "o3-mini",  # expensive | slow | very smart @ $1.10/1M tokens - 200K context window
    ...
    def __init__(
        ...
        self.severity_display_name_map = {
            ...
            'medium': 'Medium', 'low': 'Low', 'none': 'Unspecified'
        }
        ...
        self.category_color_map_suggestion = {
            ...
            'tampering': 'var(--color-chart-blue-2)',             # #89CFF0 (Lighter Blue for distinction)
            'feature_bypass': 'var(--color-chart-red-2)',           # #F87171 (Lighter Red for distinction)
        ...
        self.heatmap_custom_colorscale_blue_green = [
            ...
            [1.0, '#25B556']      # Your --color-chart-green-1 (or darker green for high counts)
        ]
        ...
        self.privileges_required_color_map = {
            'none': '#9CA3AF',  # Gray
            'low':  '#4BAEEA',  # Blue
            'high': '#F0981F'   # Orange (or '#EF4444' for Red if 'high' means more critical)
        }
        ...
        self.attack_complexity_color_map = {  # Colors for the bars (Low/High Complexity)
            'low': '#4BAEEA',  # Blue
            'high': '#F0981F'  # Orange
        }
        ...
        self.category_order = [
            'remote_code_execution', 'privilege_elevation', 'feature_bypass',
            'denial_of_service', 'disclosure', 'spoofing', 'tampering'
        ]
        ...
        self.METRICS_ELIGIBLE_FOR_TREND = {
            "total_cves", "critical_count", "important_count", "moderate_count", "low_count",
            "critical_high_pct", "high_to_total_pct",
            "median_cvss", "p90_cvss", "avg_cvss_score", "score_iqr", "score_std_dev",
            "rce_pct", "eop_pct", "dos_pct", "info_disclosure_pct", "spoofing_pct",
            "tampering_pct", "feature_bypass_pct",
            "network_vector_pct", "local_vector_pct", "adjacent_vector_pct", "physical_vector_pct",
            "no_user_action_pct", "user_action_req_pct",
            "no_privs_required_pct", "low_privs_required_pct", "high_privs_required_pct",
            "low_attack_comp_pct", "high_attack_comp_pct",
            "worst_case_cves",
            "exploited_count_kev", "exploited_pct_kev",
            "top_3_cwe_coverage_pct",
            "median_days_to_patch", "patched_le_7d_pct", "patched_le_30d_pct",
            "zero_day_count",
            "null_field_pct", "rows_analysed"
        }
        self.SYSTEM_PROMPTS = SYSTEM_PROMPTS
        self.CHART_DATA_HANDLERS = {
            # Aligned with REPORT_STRUCTURE chart IDs (looped sections)
            "new_vs_updated_monthly": self._prepare_data_for_new_vs_updated_monthly,
            "volume_by_severity_monthly": self._prepare_data_for_volume_by_severity_monthly,
            "overall_category_distribution_chart": self._prepare_data_for_overall_category_distribution_chart,
            "attack_vectors_by_privileges_chart": self._prepare_data_for_attack_vectors_by_privileges_chart,
            "interaction_vs_complexity_chart": self._prepare_data_for_interaction_vs_complexity_chart,
            "cvss_score_by_category_chart": self._prepare_data_for_cvss_score_by_category_chart,
            "top_cwe_in_high_risk_cves_chart": self._prepare_data_for_top_cwe_in_high_risk_cves_chart,
            "top_windows_versions_by_criticality_chart": self._prepare_data_for_top_windows_versions_by_criticality_chart,
            "days_to_nvd_by_severity_boxplots": self._prepare_data_for_days_to_nvd_by_severity_boxplots,
            "spotlight_cves_cvss_chart": self._prepare_data_for_spotlight_cves_base,
            "cat_av_pr_chart": self._prepare_data_for_cat_av_pr_chart,
            "cat_ui_ac_chart": self._prepare_data_for_cat_ui_ac_chart,
            "top_cwe_av_cvss_chart": self._prepare_data_for_top_cwe_av_cvss_chart,
            "tsne_cve_profile_chart": self._prepare_data_for_tsne_cve_profile_chart,
            ...
            "rce_proportion_monthly": self._prepare_data_for_rce_proportion_monthly,
            "rce_cvss_distribution": self._prepare_data_for_rce_cvss_distribution,
            "eop_proportion_monthly": self._prepare_data_for_eop_proportion_monthly,
            "eop_by_attack_vector": self._prepare_data_for_eop_by_attack_vector,
            "dos_infodisc_monthly": self._prepare_data_for_dos_infodisc_monthly,
            "user_interaction_proportion_monthly": self._prepare_data_for_user_interaction_proportion_monthly,
            "overall_attack_vector_dist": self._prepare_data_for_overall_attack_vector_dist,
            "overall_attack_complexity_dist": self._prepare_data_for_overall_attack_complexity_dist,
            "patch_delay_risk_scatter": self._prepare_data_for_patch_delay_risk_scatter,
            "kev_by_category": self._prepare_data_for_kev_by_category,
            "spotlight_cves_details_table": self._prepare_data_for_spotlight_cves_base,  # For appendix table
        }
        self.PLOTLY_FIGURE_HANDLERS = {
            ...
            "volume_by_severity_monthly": self._plot_volume_by_severity_monthly,
            "overall_category_distribution_chart": self._plot_overall_category_distribution_chart,  # Maps to figure_gen_key 'overall_category_treemap'
            "attack_vectors_by_privileges_chart": self._plot_attack_vectors_by_privileges_chart,  # Maps to 'attack_vectors_by_privileges_stacked_bar'
            "interaction_vs_complexity_chart": self._plot_interaction_vs_complexity_chart,  # Maps to 'interaction_vs_complexity_heatmap'
            "cvss_score_by_category_chart": self._plot_cvss_score_by_category_chart,  # Maps to 'cvss_score_by_category_chart_faceted'
            "top_cwe_in_high_risk_cves_chart": self._plot_top_cwe_in_high_risk_cves_chart,  # Maps to 'top_cwe_in_high_risk_dot_plot'
            "top_windows_versions_by_criticality_chart": self._plot_top_windows_versions_by_criticality_chart,  # Maps to 'top_windows_versions_by_criticality_bar'
            "days_to_nvd_by_severity_boxplots": self._plot_days_to_nvd_by_severity_boxplots,  # Maps to 'days_to_nvd_by_severity_boxplots_faceted'
            "spotlight_cves_cvss_chart": self._plot_spotlight_cves_cvss_scores_dot_plot,  # Maps to 'spotlight_cves_cvss_scores_bar'
            ...
            "user_interaction_proportion_monthly": self._plot_user_interaction_proportion_monthly,
            "overall_attack_vector_dist": self._plot_overall_attack_vector_dist,
            "overall_attack_complexity_dist": self._plot_overall_attack_complexity_dist,
        ...
        self.TOKEN_PRICING = {
            ...
            "gpt-3.5-turbo":    {"input_1k": 0.0015,  "output_1k": 0.002},   # Explicit gpt-3.5-turbo entry
            ...
            "openrouter/google/gemini-2.5-pro-preview": {"input_1k": 0.000125, "output_1k": 0.001},
    ...
    def _count_tokens(model_name: str, text: str) -> int:
        ...
        try:
            ...
            logger.info(f"Original model_name: '{model_name}', normalized: '{normalized_model_name}'")
            ...
            if "gpt-4o-mini" == normalized_model_name or \
               "gpt-o4-mini-high" == normalized_model_name:
                ...
                tiktoken_model_key = "gpt-3.5-turbo"
            elif "gemini" in normalized_model_name or "google/gemini" in model_name.lower():
                logger.info(
            ...
            logger.info(f"Using tiktoken model key: '{tiktoken_model_key}' for model '{model_name}'")

            try:
                encoding = tiktoken.encoding_for_model(tiktoken_model_key)
                logger.info(f"Successfully got encoding for '{tiktoken_model_key}'")
            except KeyError:
                logger.warning(
                    f"Tiktoken encoding not found for derived key "
            ...
            try:
                ...
                logger.info(f"Token count for model '{model_name}': {len(tokens)}")
                return len(tokens)
    ...
    def _extract_base_score_rating(df: pd.DataFrame) -> pd.Series:
        ...
        available_rating_cols = [col for col in rating_cols_priority if col in df.columns]

        if not available_rating_cols:
            logger.warning("No recognized base score rating columns found. Cannot extract severity.")
            ...
            for col in available_rating_cols:  # Iterate in priority order
                ...
                if pd.notna(value) and str(value).strip():
                    ...
                    if rating in valid_ratings:
                        return rating  # *** RETURN the first valid one found ***
    ...
    @staticmethod
    def _normalise_cwe_column(df: pd.DataFrame, col: str = "cwe_id") -> pd.Series:
    ...
    @staticmethod
    def _compute_cwe_metrics(df: pd.DataFrame, prior_df: pd.DataFrame | None = None):
        ...
        cwe_metrics_results = {
            ...
            "new_cwe_types_this_qtr": 0,  # Placeholder - requires historical data comparison
            "cwe_category_distribution": {}
        }
        total_cves_with_cwe = 0

        if "cwe_id" not in df.columns or df["cwe_id"].isna().all():
            logger.warning("CWE metrics calculation skipped: 'cwe_id' column missing or empty.")
        ...
        df_cwe_expanded['cwe_id_list'] = df_cwe_expanded['cwe_id'].str.findall(r'(CWE-\d+)')
        df_cwe_expanded = df_cwe_expanded.explode('cwe_id_list').rename(columns={'cwe_id_list': 'primary_cwe_id'})

        if df_cwe_expanded.empty or 'primary_cwe_id' not in df_cwe_expanded.columns or df_cwe_expanded['primary_cwe_id'].isna().all():
        ...
        total_cves_with_cwe = df_cwe_expanded.dropna(subset=['primary_cwe_id'])['cve_id'].nunique()

        if cwe_counts.empty or total_cves_with_cwe == 0:
            logger.warning("No CWE counts found after processing or no CVEs with valid CWEs.")
            return cwe_metrics_results
        ...
        cwe_metrics_results["top_3_cwe_coverage_pct"] = round((top_3_count / total_cves_with_cwe * 100), 1) if total_cves_with_cwe else 0
        ...
        if unknown_cwe_count > 0:
            logger.warning(f"{unknown_cwe_count} occurrences of CWE IDs not found in defined categories.")
        ...
        if memory_bugs_count > 0 and logic_bugs_count > 0:
            ...
            cwe_metrics_results["memory_safety_vs_logic_bugs_pct"] = f"{ratio}:1"
        elif memory_bugs_count > 0:
            cwe_metrics_results["memory_safety_vs_logic_bugs_pct"] = "Inf:1 (No Logic)"  # Indicate only memory bugs found
        elif logic_bugs_count > 0:
            cwe_metrics_results["memory_safety_vs_logic_bugs_pct"] = "1:Inf (No Memory)"  # Indicate only logic bugs found
        else:
            cwe_metrics_results["memory_safety_vs_logic_bugs_pct"] = "N/A (None Found)"
    ...
    def _get_exploded_standardized_products(
        self,
        df: pd.DataFrame,
        product_column_name: str = 'products'
        ...
        if df_exploded.empty or df_exploded[product_column_name].isnull().all():
            logger.warning(
                f"DataFrame became empty or product column '{product_column_name}' "
                f"is all null after exploding."
            )
    ...
    def _prepare_input_dataframe(self, report_data: pd.DataFrame) -> pd.DataFrame:
        ...
        if 'cve_category' in df.columns:
            ...
            df['cve_category'] = df['cve_category'].map(category_map).fillna('none')
        else:
        ...
        patterns_to_lower = [
            "attack_vector", "attack_complexity", "user_interaction", "privileges_required",
            "cve_category", "severity_type", "confidentiality", "integrity", "availability", "scope"
        ]
        ...
        df['severity_type'].fillna(QuarterlyDeepDiveReportGenerator._extract_base_score_rating(df))
    ...
    # -----------------------------------------------------------------------------
    def _get_previous_period_key(self, current_start_date: datetime.date) -> str:
        """
    ...
    async def _fetch_previous_period_metrics(
        ...
        if not metrics_service:
            logger.warning("Metrics service is not available. Cannot fetch previous period metrics.")
            return None

        previous_period_key = self._get_previous_period_key(current_start_date)
        logger.debug(f"Attempting to fetch metrics for previous period: {previous_period_key}")
        ...
        try:
            ...
            previous_metrics_raw = await metrics_service.get_metrics_for_period(previous_period_key)

            if not previous_metrics_raw:
                logger.warning(f"No metrics found for previous period: {previous_period_key}")
                return None

            previous_metrics_dict: Dict[str, Any] = {}
            for metric_obj in previous_metrics_raw:
                key = metric_obj.metric_key  # Assuming FactMetricValue has 'metric_key'
                ...
                if metric_obj.numeric_val is not None:
                    ...
                    if isinstance(json_data, dict):
                        if "data" in json_data and len(json_data) == 1 and isinstance(json_data["data"], list):
                            value_to_store = json_data["data"]  # Unwrap list
                        elif "value" in json_data and len(json_data) == 1:
                            value_to_store = json_data["value"]  # Unwrap string or other single value
                        else:
            ...
            logger.debug(f"Successfully fetched and re-assembled {len(previous_metrics_dict)} metrics for previous period: {previous_period_key}")
            return previous_metrics_dict

        except Exception as e:
            logger.error(f"Error fetching or processing metrics for previous period {previous_period_key}: {e}", exc_info=True)
            return None
    ...
    def _calculate_all_metrics(
        ...
        """
        if df.empty:
            logger.warning("DataFrame is empty, skipping all metric calculations.")
            return {}
        if previous_period_metrics:
            logger.debug(f"Previous period metrics available with {len(previous_period_metrics)} keys.")
        else:
            logger.debug("No previous period metrics available for trend calculation.")
        ...
        total_cves_val = calculated_values["total_cves"]  # Use this consistent variable

        if 'severity_type' in df.columns:
            # Assuming severity_type column was standardized (e.g., to lowercase) in preprocessing
            calculated_values["critical_count"] = len(df[df['severity_type'] == 'critical'])
            calculated_values["important_count"] = len(df[df['severity_type'] == 'high'])
            calculated_values["moderate_count"] = len(df[df['severity_type'] == 'medium'])
            calculated_values["low_count"] = len(df[df['severity_type'] == 'low'])

            if total_cves_val > 0:
                crit_high_count = len(df[df['severity_type'].isin(['critical', 'high'])])
                calculated_values["critical_high_pct"] = (crit_high_count / total_cves_val * 100)
                high_count = calculated_values.get("important_count", 0)
                calculated_values["high_to_total_pct"] = (high_count / total_cves_val * 100)
            else:
                calculated_values["critical_high_pct"] = 0.0
                calculated_values["high_to_total_pct"] = 0.0
        else:
            logger.warning("Missing 'severity_type' column, cannot calculate severity-based metrics.")
        ...
        if "published" in df.columns:
            if df["published"].notna().any():
                ...
                if not monthly_periods.empty:
                    ...
                    if not monthly_counts.empty:
                        ...
                        calculated_values["most_volatile_month"] = str(most_frequent_period)
                    else:
            ...
            calculated_values["most_volatile_month"] = None  # Indicate column missing
        ...
        if cvss_col in df.columns and df[cvss_col].notna().any():
            ...
            if not valid_cvss.empty:
                ...
                calculated_values["score_iqr"] = q75 - q25 if pd.notna(q75) and pd.notna(q25) else None
            ...
            if 'cve_category' in df.columns and df['cve_category'].notna().any():
                category_stats_dict = {}
                try:
                    df_cleaned_for_grouping = df.copy()
                    df_cleaned_for_grouping[cvss_col] = pd.to_numeric(df_cleaned_for_grouping[cvss_col], errors='coerce')
                    # Ensure cve_category is also string for consistent grouping keys
                    df_cleaned_for_grouping['cve_category'] = df_cleaned_for_grouping['cve_category'].astype(str)
                    df_cleaned_for_grouping = df_cleaned_for_grouping.dropna(subset=[cvss_col, 'cve_category'])

                    if not df_cleaned_for_grouping.empty:
                        grouped = df_cleaned_for_grouping.groupby('cve_category')[cvss_col]
                        aggregated_stats = grouped.agg(
                            Q1=lambda x: x.quantile(0.25), Median=lambda x: x.median(), Q3=lambda x: x.quantile(0.75),
                            Count=lambda x: x.count(), Mean=lambda x: x.mean(), StdDev=lambda x: x.std()
                        ).reset_index()
                        ...
                        for _, row in aggregated_stats.iterrows():
                            ...
                            if category.lower() == 'nan': continue

                            q1, median, q3 = row['Q1'], row['Median'], row['Q3']
                            count, mean, std_dev = row['Count'], row['Mean'], row['StdDev']
                            iqr = q3 - q1 if pd.notna(q1) and pd.notna(q3) else None
                            lower_fence = q1 - 1.5 * iqr if pd.notna(iqr) else None
                            upper_fence = q3 + 1.5 * iqr if pd.notna(iqr) else None

                            # Get color hint - assumes category names match keys in CATEGORY_COLOR_CLASSES or preprocessed to match
                            color_hint_key = category.lower().replace(' ', '_')  # Example preprocessing

                            category_stats_dict[category] = {
                                "Q1": round(q1, 2) if pd.notna(q1) else None, "Median": round(median, 2) if pd.notna(median) else None,
                                "Q3": round(q3, 2) if pd.notna(q3) else None, "IQR": round(iqr, 2) if pd.notna(iqr) else None,
                                "Lower_Fence": round(lower_fence, 2) if pd.notna(lower_fence) else None,
                                "Upper_Fence": round(upper_fence, 2) if pd.notna(upper_fence) else None,
                                "Count": int(count) if pd.notna(count) else 0, "Mean": round(mean, 2) if pd.notna(mean) else None,
                                "StdDev": round(std_dev, 2) if pd.notna(std_dev) else None,
                                "id_for_color": color_hint_key  # Added hint for formatter
                            }
                        calculated_values["cvss_iqr_by_category"] = category_stats_dict
                    else:
                        calculated_values["cvss_iqr_by_category"] = {}
                except Exception as e:
                    logger.error(f"Error calculating CVSS stats by category: {e}", exc_info=True)
                    calculated_values["cvss_iqr_by_category"] = {}
            else:
                calculated_values["cvss_iqr_by_category"] = {}  # Indicate category column missing
        else:  # CVSS column missing
            calculated_values["median_cvss"] = None; calculated_values["p90_cvss"] = None
            calculated_values["highest_cvss"] = None; calculated_values["lowest_cvss"] = None
            calculated_values["score_iqr"] = None; calculated_values["score_std_dev"] = None
            calculated_values["avg_cvss_score"] = None; calculated_values["cvss_iqr_by_category"] = {}
        ...
        if "cve_category" in df.columns and total_cves_val > 0:
            ...
            calculated_values["cve_category_distribution_raw_counts"] = category_counts.to_dict()  # Store raw counts

            # Calculate individual shares
            calculated_values["rce_pct"] = (category_counts.get("remote_code_execution", 0) / total_cves_val * 100)
            calculated_values["eop_pct"] = (category_counts.get("privilege_elevation", 0) / total_cves_val * 100)
            calculated_values["dos_pct"] = (category_counts.get("denial_of_service", 0) / total_cves_val * 100)
            # Ensure your category names match exactly or use .get with default 0
            calculated_values["info_disclosure_pct"] = (category_counts.get("disclosure", 0) / total_cves_val * 100)
            calculated_values["spoofing_pct"] = (category_counts.get("spoofing", 0) / total_cves_val * 100)
            calculated_values["tampering_pct"] = (category_counts.get("tampering", 0) / total_cves_val * 100)
            calculated_values["feature_bypass_pct"] = (category_counts.get("feature_bypass", 0) / total_cves_val * 100)

            calculated_values["top_impact_type"] = category_counts.idxmax() if not category_counts.empty else "nc"

            # Prepare data for the comparison bar card (list of dicts)
            comparison_bar_data = []
            for cat_name, count in category_counts.items():
                color_hint_key = cat_name.lower().replace(' ', '_')  # Example preprocessing
                comparison_bar_data.append({
                    'name': cat_name.replace("_", " ").title(),  # Make name readable
                    'count': count,
                    'percentage': (count / total_cves_val * 100),
                    'id_for_color': color_hint_key
                })
            # Sort by count desc for the bar chart display order
            calculated_values["cve_category_distribution"] = sorted(comparison_bar_data, key=lambda x: x['count'], reverse=True)
        ...
        exploitability_cols = ['attack_vector', 'user_interaction', 'privileges_required', 'attack_complexity']
        if all(col in df.columns for col in exploitability_cols):
            if total_cves_val > 0:
                # Assuming lowercase standardization in preprocessing
                calculated_values["network_vector_pct"] = (df['attack_vector'].eq('network').sum() / total_cves_val * 100)
                calculated_values["local_vector_pct"] = (df['attack_vector'].eq('local').sum() / total_cves_val * 100)
                calculated_values["adjacent_vector_pct"] = (df['attack_vector'].eq('adjacent').sum() / total_cves_val * 100)
                calculated_values["physical_vector_pct"] = (df['attack_vector'].eq('physical').sum() / total_cves_val * 100)

                calculated_values["no_user_action_pct"] = (df['user_interaction'].eq('none').sum() / total_cves_val * 100)
                calculated_values["user_action_req_pct"] = (df['user_interaction'].eq('required').sum() / total_cves_val * 100)

                calculated_values["no_privs_required_pct"] = (df['privileges_required'].eq('none').sum() / total_cves_val * 100)
                calculated_values["low_privs_required_pct"] = (df['privileges_required'].eq('low').sum() / total_cves_val * 100)
                calculated_values["high_privs_required_pct"] = (df['privileges_required'].eq('high').sum() / total_cves_val * 100)

                calculated_values["low_attack_comp_pct"] = (df['attack_complexity'].eq('low').sum() / total_cves_val * 100)
                calculated_values["high_attack_comp_pct"] = (df['attack_complexity'].eq('high').sum() / total_cves_val * 100)

                # Worst case CVEs (example definition)
                try:
                    if total_cves_val > 0:
                        # Calculate normalized values for each factor (0-1 scale)
                        df['av_score'] = df['attack_vector'].map({
                            'network': 0.85,
                            'adjacent': 0.62,
                            'local': 0.55,
                            'physical': 0.2
                        ...
                        df['ac_score'] = df['attack_complexity'].map({
                            'low': 0.77,
                            'high': 0.44
                        }).fillna(0)

                        df['pr_score'] = df['privileges_required'].map({
                            'none': 0.85,
                            'low': 0.62,
                            'high': 0.27
                        }).fillna(0)

                        df['ui_score'] = df['user_interaction'].map({
                            'none': 0.85,
                            'required': 0.62
                        }).fillna(0)
                        ...
                        calculated_values["worst_case_cves"] = int((df['risk_score'] >= high_risk_threshold).sum())

                        # Create a list of high-risk CVE details
                        high_risk_cves_list = []
                        if calculated_values["worst_case_cves"] > 0:
                            high_risk_df = df[df['risk_score'] >= high_risk_threshold]
                        ...
                        calculated_values["high_risk_cves"] = high_risk_cves_list
                    else:
                        calculated_values["worst_case_cves"] = 0
                        calculated_values["high_risk_cves"] = []
                except Exception as e:
                    logger.error(f"Error calculating worst_case_cves with risk score: {e}", exc_info=True)
                    calculated_values["worst_case_cves"] = None
                    calculated_values["high_risk_cves"] = []

            else:  # total_cves_val is 0
                for key in ["network_vector_pct", "local_vector_pct", "adjacent_vector_pct", "physical_vector_pct",
                            "no_user_action_pct", "user_action_req_pct", "no_privs_required_pct",
                            "low_privs_required_pct", "high_privs_required_pct", "low_attack_comp_pct",
                            "high_attack_comp_pct", "worst_case_cves"]:
                    calculated_values[key] = 0.0 if "pct" in key else (0 if "cves" in key else None)
        else:
            missing_cols = [col for col in exploitability_cols if col not in df.columns]
            logger.warning(f"Missing one or more exploitability columns ({missing_cols}), cannot calculate related metrics.")
            # Set relevant metrics to None or default
            for key in ["network_vector_pct", "local_vector_pct", "adjacent_vector_pct", "physical_vector_pct",
                        "no_user_action_pct", "user_action_req_pct", "no_privs_required_pct",
                        "low_privs_required_pct", "high_privs_required_pct", "low_attack_comp_pct",
        ...
        if 'cisa_kev' in df.columns:  # Check if KEV data is present
            calculated_values["exploited_count_kev"] = int(df['cisa_kev'].astype(bool).sum())
            if total_cves_val > 0:
                calculated_values["exploited_pct_kev"] = (calculated_values["exploited_count_kev"] / total_cves_val * 100)
            else:
        ...
        if "build_numbers" in df.columns and df["build_numbers"].notna().any():
            ...
            try:
                build_series = df.dropna(subset=["build_numbers"])["build_numbers"]

                def build_to_string(build):
                    if isinstance(build, list) and len(build) == 4:
                        try: return '.'.join(map(str, build))
                        except TypeError: return None
                    return None
                if not build_series.empty and isinstance(build_series.iloc[0], list):
                    exploded_builds = build_series.explode()
                    build_strings = exploded_builds.apply(build_to_string).dropna()
                    if not build_strings.empty:
                        build_counts = build_strings.value_counts()
                        top_3_list = build_counts.head(3).reset_index().values.tolist()
                        calculated_values["top_3_affected_builds"] = [{"build": item[0], "count": item[1]} for item in top_3_list]
                    else: calculated_values["top_3_affected_builds"] = []
                else: calculated_values["top_3_affected_builds"] = []
            except Exception as e:
                logger.error(f"Error processing build_numbers for top_3_affected_builds: {e}", exc_info=True)
                calculated_values["top_3_affected_builds"] = [{"build": "Error Parsing", "count": 0}]
        else:
            calculated_values["top_3_affected_builds"] = []  # Or None if preferred

        # --- CWE Weaknesses ---
        if "cwe_id" in df.columns and df["cwe_id"].notna().any():
            try:
                cwe_metrics = self._compute_cwe_metrics(df)  # Assumes this helper exists
                calculated_values["top_cwe_id"] = cwe_metrics.get("top_cwe_id", "N/A")
                calculated_values["top_3_cwe_coverage_pct"] = cwe_metrics.get("top_3_cwe_coverage_pct", 0.0)
                calculated_values["memory_safety_vs_logic_bugs_pct"] = cwe_metrics.get("memory_safety_vs_logic_bugs_pct", None)
                calculated_values["new_cwe_types_this_qtr"] = cwe_metrics.get("new_cwe_types_this_qtr", 0)
            except Exception as e:
                logger.error(f"Error computing CWE metrics: {e}", exc_info=True)
                # Set defaults if computation fails
                calculated_values["top_cwe_id"] = "Error"; calculated_values["top_3_cwe_coverage_pct"] = None
                calculated_values["memory_safety_vs_logic_bugs_pct"] = None; calculated_values["new_cwe_types_this_qtr"] = None
        else:
            calculated_values["top_cwe_id"] = None; calculated_values["top_3_cwe_coverage_pct"] = None
            calculated_values["memory_safety_vs_logic_bugs_pct"] = None; calculated_values["new_cwe_types_this_qtr"] = None

        # --- Patch Timeliness ---
        if "published" in df.columns and "patch_date" in df.columns:
            # Assuming datetime conversion happened in preprocessing
            df_valid_dates = df.dropna(subset=['published', 'patch_date']).copy()
            if not df_valid_dates.empty:
                df_valid_dates['patch_delta_days'] = (df_valid_dates['published'] - df_valid_dates['patch_date']).dt.days
                positive_delta_df = df_valid_dates[df_valid_dates['patch_delta_days'] >= 0]
                calculated_values["median_days_to_patch"] = positive_delta_df['patch_delta_days'].median() if not positive_delta_df.empty else 0.0

                total_comparable = len(df_valid_dates)
                if total_comparable > 0:
                    count_le_7d = (df_valid_dates['patch_delta_days'] <= 7).sum()
                    calculated_values["patched_le_7d_pct"] = (count_le_7d / total_comparable * 100)
                    count_le_30d = (df_valid_dates['patch_delta_days'] <= 30).sum()
                    calculated_values["patched_le_30d_pct"] = (count_le_30d / total_comparable * 100)
                else:
                    calculated_values["patched_le_7d_pct"] = 0.0; calculated_values["patched_le_30d_pct"] = 0.0
                ...
                if "exploited" in df.columns:
                    ...
                    zero_day_df = df_valid_dates[
                        ...
                        (df_valid_dates['published'] >= df_valid_dates['patch_date'])  # NVD Published >= Vendor Patch Date
                        # Potentially refine based on specific 'exploited' data meaning
                    ]
                    calculated_values["zero_day_count"] = len(zero_day_df)
                else:
                    calculated_values["zero_day_count"] = None  # Indicate exploited column missing
            else:  # Not enough valid date pairs
                calculated_values["median_days_to_patch"] = None; calculated_values["patched_le_7d_pct"] = None
                calculated_values["patched_le_30d_pct"] = None; calculated_values["zero_day_count"] = None
        ...
        if "products" in df.columns and "cve_id" in df.columns:
            ...
            if (processed_products_df is not None and
                    not processed_products_df.empty and
                    'standardized_product' in processed_products_df.columns):

                # Group by the standardized product name and count unique CVE IDs.
                # Ensure 'cve_id' here matches your actual CVE ID column name.
                product_counts = processed_products_df.groupby(
                    'standardized_product'
                )['cve_id'].nunique().sort_values(ascending=False)

                if not product_counts.empty:
                    calculated_values['most_affected_product'] = product_counts.index[0]
                else:
                    logger.info("No product counts found after processing for 'most_affected_product'.")
            else:
                logger.info(
                    "Processed products DataFrame is None, empty, or missing 'standardized_product' "
                    "for 'most_affected_product'."
                )
        else:
            logger.warning(
                "Required columns ('affected_products' or 'cve_id') not found in df "
                "for 'most_affected_product' calculation."
            )
            calculated_values['most_affected_product'] = None # Or "N/A" if preferred when columns are missing
        ...
        key_cols = ['cvss_score', 'cwe_id', 'cve_category', 'severity_type', 'attack_vector', 'patch_date']
        ...
        if existing_key_cols and not df.empty:
            ...
            calculated_values["null_field_pct"] = (null_cells / total_cells * 100) if total_cells > 0 else 0.0
        else:
            calculated_values["null_field_pct"] = None  # Indicate issue calculating
        ...
        logger.info(f"Finished calculating metrics. Total metrics calculated: {len(calculated_values)}")
        # logger.debug(f"Calculated values: {calculated_values}") # Optional debug

        # --- SECTION: Calculate Quarter-over-Quarter (QoQ) Trends ---
        if previous_period_metrics:
            logger.debug("Calculating QoQ trends using previous period metrics...")
            for metric_id in self.METRICS_ELIGIBLE_FOR_TREND:
                current_value = calculated_values.get(metric_id)
                previous_value = previous_period_metrics.get(metric_id)  # Assumes keys are the same
                ...
                if isinstance(current_value, (int, float)) and \
                   ...
                   pd.notna(current_value) and pd.notna(previous_value):
                    ...
                    if previous_value != 0:
                        ...
                        calculated_values[f"{metric_id}_qoq_delta_pct"] = delta_pct
                    else:
                        ...
                        if current_value == 0:
                            calculated_values[f"{metric_id}_qoq_delta_pct"] = 0.0
                        else:
                            ...
                            calculated_values[f"{metric_id}_qoq_delta_pct"] = None  # Or some indicator like float('inf') if you handle it
                            logger.debug(f"QoQ % change for '{metric_id}' is undefined (previous was 0, current is {current_value}).")
                    ...
                    if delta_abs > 0:
                        calculated_values[f"{metric_id}_qoq_trend_direction"] = "up"
                    elif delta_abs < 0:
                        calculated_values[f"{metric_id}_qoq_trend_direction"] = "down"
                    else:
                        calculated_values[f"{metric_id}_qoq_trend_direction"] = "neutral"
                else:
                    ...
                    if metric_id in calculated_values: # Only log if current value was attempted
                        logger.debug(f"Could not calculate QoQ trend for '{metric_id}'. Current: {current_value}, Previous: {previous_value}")
        else:
        ...
        logger.info(f"Finished calculating all metrics. Total metrics: {len(calculated_values)}")
    ...
    def _format_metrics_for_report_cards(self, calculated_metrics: Dict[str, Any]) -> Dict[str, List[Dict]]:
        """
        ...
        for section_key, section_config in sections_to_process.items():
            ...
            for stat_def in section_config.get("stats_definitions", []):
                ...
                card_style_definition = self.CARD_STYLES.get(card_style_key, self.CARD_STYLES.get("default_standard", {}))
                logger.info(f"Processing metric: {metric_id} with style_key: {card_style_key}")
                logger.debug(f"Raw value type: {type(raw_value)} -> {raw_value}")
                # Defaults for simple cards
                formatted_value_simple = "N/A"
                unit_simple = None

                label_simple = stat_def.get("title", self.STAT_CARD_LABELS.get(metric_id, metric_id.replace("_", " ").title()))
                subtitle_simple = self.STAT_CARD_SUBTITLES.get(metric_id, "")
                icon_name_key = self.STAT_CARD_ICONS.get(metric_id, "default")
                icon_svg_simple = self.ICON_SVG_STRINGS.get(icon_name_key, self.ICON_SVG_STRINGS.get("default", "<svg><!-- fallback SVG --></svg>"))
                trend_value_display = None    # For formatted trend string e.g., "+5.2%"
                trend_direction_final = None  # 'up', 'down', 'neutral', or None
                ...
                if metric_id in self.METRICS_ELIGIBLE_FOR_TREND:
                    ...
                    delta_abs = calculated_metrics.get(f"{metric_id}_qoq_delta_abs")
                    delta_pct = calculated_metrics.get(f"{metric_id}_qoq_delta_pct")
                    trend_direction_final = calculated_metrics.get(f"{metric_id}_qoq_trend_direction")

                    if trend_direction_final is not None: # A valid trend direction was determined
                        # Prioritize showing percentage change if available and numeric
                        if isinstance(delta_pct, (int, float)) and pd.notna(delta_pct):
                            ...
                            if trend_direction_final == "neutral":
                                ...
                                if abs(delta_pct) < 0.001 :
                                    ...
                                    trend_value_display = f"{abs(delta_pct):.1f}%"  # Show absolute value
                            else:  # Up or Down
                                trend_value_display = f"{abs(delta_pct):.1f}%"

                        # Fallback to absolute change if percentage is not available/numeric
                        elif isinstance(delta_abs, (int, float)) and pd.notna(delta_abs):
                            if trend_direction_final == "neutral":
                                if abs(delta_abs) < 0.001:  # Check if it's effectively zero
                                    trend_value_display = "±0"
                                    # If metric_id is a percentage itself, format as percent
                                    if "_pct" in metric_id: trend_value_display += "%"
                                else:  # Should be 0 if neutral
                                    trend_value_display = f"{abs(delta_abs):.1f}"  # Show absolute value
                                    if "_pct" in metric_id: trend_value_display += "%"  # Add % if original metric was a pct
                            else:  # Up or Down
                                if isinstance(calculated_metrics.get(metric_id), int) or \
                                   (isinstance(delta_abs, float) and delta_abs.is_integer()):
                                    trend_value_display = f"{abs(int(delta_abs)):,}"
                                else:
                                    trend_value_display = f"{abs(delta_abs):,.1f}"
                                if "_pct" in metric_id and not trend_value_display.endswith('%'):  # If base metric is %, and we show abs delta
                        ...
                        if trend_direction_final == "neutral" and trend_value_display is None:
                ...
                if card_style_key == "category_comparison_bar_style" and metric_id == "cve_category_distribution":
                    if isinstance(raw_value, list):
                        complex_card_structured_value_temp = []
                        for item in raw_value:
                            color_hint_key = item.get('id_for_color', item.get('name', 'default').lower().replace(' ', '_'))
                            color_class = CVE_CATEGORY_COLOR_MAP.get(color_hint_key)
                        ...
                        none_like_categories = ["none", "unknown", "nc", "other"]  # Define what counts as "None"

                        items_none = [item for item in complex_card_structured_value_temp if item['name'].lower() in none_like_categories]
                        items_other = [item for item in complex_card_structured_value_temp if item['name'].lower() not in none_like_categories]

                        items_other_sorted = sorted(items_other, key=lambda x: x['percentage'], reverse=True)
                        items_none_sorted = sorted(items_none, key=lambda x: x['percentage'], reverse=True)  # Also sort "None" items if multiple

                        complex_card_structured_value = items_other_sorted + items_none_sorted  # "None" items append at the end

                        label_simple = self.STAT_CARD_LABELS.get(metric_id, "Vulnerability Categories")
                    else:
                        # Data not in expected format for this complex card, fallback or log error
                        complex_card_structured_value = [{'name': 'Error', 'count': 0, 'percentage': 0.0, 'color_class': 'bg-red-500'}]
                        label_simple = self.STAT_CARD_LABELS.get(metric_id, "Category Data Error")

                elif card_style_key == "cvss_iqr_by_category_style" and metric_id == "cvss_iqr_by_category":
                    # logger.info(f"Processing complex card: {metric_id} with style {card_style_key}")
                    logger.info(f"Raw value type for {metric_id}: {type(raw_value)}")
                    if isinstance(raw_value, dict):  # Expecting a dict where keys are category names
                        ...
                        for cat_name, stats in raw_value.items():
                            ...
                            color_hint_key = stats.get('id_for_color', cat_name.lower().replace(' ', '_'))
                            color_class = CVE_CATEGORY_COLOR_MAP.get(color_hint_key)
                        ...
                        complex_card_structured_value = sorted(
                            temp_list_for_sorting,
                            key=lambda x: x['median'] if x['median'] is not None else -1,  # Sort Nones last (as -1)
                            reverse=True  # Higher median = higher severity = comes first
                        )

                        label_simple = self.STAT_CARD_LABELS.get(metric_id)
                        logger.debug(f"Built complex_card_structured_value for {metric_id}: {complex_card_structured_value}")
                    else:
                        logger.error(f"ERROR: For {metric_id}, raw_value was NOT a dict as expected! Type: {type(raw_value)}")
                        complex_card_structured_value = [{'name': 'Error', 'q1': 0, 'median': 0, 'q3': 0, 'iqr': 0, 'color_class': 'bg-red-500'}]
                        label_simple = self.STAT_CARD_LABELS.get(metric_id, "CVSS Stats Error")

                # --- Formatting for simple card types (if not a complex card processed above) ---
                if complex_card_structured_value is None:
                    if raw_value is not None:
                        if metric_id == 'most_volatile_month' and raw_value and isinstance(raw_value, str) and '-' in raw_value:
                            try:
                                ...
                                formatted_value_simple = month_dt.strftime('%B')  # "March 2024"
                                # Or for just month name: formatted_value_simple = month_dt.strftime('%B') # "March"
                            except ValueError:
                                formatted_value_simple = raw_value

                        elif metric_id == 'median_days_to_patch' and raw_value and isinstance(raw_value, str):
                            unit_simple = "days"

                        elif metric_id == 'top_impact_type' and raw_value and isinstance(raw_value, str):
                            if raw_value.lower() == "remote_code_execution":
                                formatted_value_simple = "Remote Code Execution"
                                ...
                                formatted_value_simple = "Information Disclosure"
                            elif raw_value.lower() == "feature_bypass":
                                formatted_value_simple = "Security Feature Bypass"
                            ...
                            if isinstance(raw_value, dict) and "products" in raw_value and "count" in raw_value:
                                ...
                                if num_tied_products == 0:
                                    ...
                                    formatted_value_simple = products_list[0].title()
                                    subtitle_simple = f"{cve_count} CVEs"
                                    # text_size_class_to_add remains 'text-lg'
                                elif num_tied_products == 2:
                                    formatted_value_simple = f"{products_list[0].title()} & {products_list[1].title()}"
                                    subtitle_simple = f"{num_tied_products} Products Tied ({cve_count} CVEs each)"
                                    text_size_class_to_add = 'text-md' # Slightly smaller
                                elif num_tied_products == 3:
                                    formatted_value_simple = ", ".join([p.title() for p in products_list[:3]])
                                    subtitle_simple = f"{num_tied_products} Products Tied ({cve_count} CVEs each)"
                                    text_size_class_to_add = 'text-sm' # Even smaller
                                else:  # More than 3 tied products
                                    formatted_value_simple = f"{num_tied_products} Products Tied"
                                    example_prods = ", ".join([p.title() for p in products_list[:2]])
                                    subtitle_simple = f"e.g., {example_prods}, etc. ({cve_count} CVEs each)"
                                    text_size_class_to_add = 'text-base' # Reset to a readable size for summary

                            elif raw_value is None: # Handles the case where calculation resulted in None
                                formatted_value_simple = "N/A"
                            ...
                            current_value_classes = card_style_definition.get('value', '')
                            ...
                            existing_text_sizes = ['text-xs', 'text-sm', 'text-base', 'text-lg', 'text-xl', 'text-2xl', 'text-3xl', 'text-4xl', 'text-5xl', 'text-6xl', 'text-7xl', 'text-8xl', 'text-9xl']
                            cleaned_value_classes = ' '.join(c for c in current_value_classes.split() if c not in existing_text_sizes)

                            # Add the new text size class
                            card_style_definition['value'] = f"{cleaned_value_classes} {text_size_class_to_add}".strip()

                        elif metric_id.startswith("spotlight_cwe_slot_"):
                            cwe_item_data = calculated_metrics.get(metric_id)
                            if cwe_item_data and isinstance(cwe_item_data, dict):
                                cwe_id_raw = cwe_item_data['cwe_id_raw']  # e.g., "CWE-79"

                                # Construct keys for predefined labels, subtitles, styles using the raw CWE ID
                                predefined_label_key = f"spotlight_cwe_{cwe_id_raw}"
                                predefined_subtitle_key = f"spotlight_cwe_{cwe_id_raw}"  # Or a generic one
                                predefined_style_key = f"spotlight_cwe_{cwe_id_raw}_card"  # For per-CWE specific style

                                # Get card style: try specific, then default for slot, then overall default
                                base_card_style = self.CARD_STYLES.get(predefined_style_key)
                                card_style_for_item = base_card_style.copy()
                                label = self.STAT_CARD_LABELS.get(predefined_label_key, cwe_item_data['display_cwe_label'])
                                # Primary subtitle from STAT_CARD_SUBTITLES for the specific CWE, if defined
                                subtitle = self.STAT_CARD_SUBTITLES.get(predefined_subtitle_key, "")

                                formatted_value = str(cwe_item_data['count'])
                                # This will be passed as an extra field for the Jinja template to use
                                predominant_category_for_card = cwe_item_data['display_predominant_category']
                                avg_cvss_for_card = cwe_item_data['avg_cvss']

                                icon_name_key = self.STAT_CARD_ICONS.get(predefined_label_key)
                                icon_svg = self.ICON_SVG_STRINGS.get(icon_name_key, None)

                                category_key_for_color_map = predominant_category_for_card.lower().replace(" ", "_") if predominant_category_for_card else 'unknown'
                                raw_bg_color_class = self.CVE_CATEGORY_COLOR_MAP.get(category_key_for_color_map, self.CVE_CATEGORY_COLOR_MAP.get('default', 'bg-chart-gray-2 dark:bg-chart-gray-2-dark'))
                                text_color_class_for_category = raw_bg_color_class.replace('bg-', 'text-') if raw_bg_color_class else 'text-report-text-muted dark:text-report-text-muted-dark'
                                existing_predominant_style = card_style_for_item.get("predominant_category_text")
                                card_style_for_item["predominant_category_text"] = f"{existing_predominant_style} {text_color_class_for_category}"
                                final_card_data_for_jinja = {
                                    "id": metric_id,  # Use the slot_id, e.g. "spotlight_cwe_slot_1"
                                    "value": formatted_value,  # This is the count
                                    "unit": "CVEs",
                                    "label": label,  # "CWE-XXX: Name"
                                    "subtitle": subtitle,  # Main subtitle (if any predefined)
                                    "icon_svg": icon_svg,
                                    "predominant_category": predominant_category_for_card,
                                    "avg_cvss": avg_cvss_for_card,
                                    "cwe_id_raw_for_styling": cwe_id_raw,  # Potentially for template logic
                                    "card_layout_style": stat_def.get("card_style"),  # e.g., "spotlight_cwe_default_style"
                                ...
                                logger.info(f"No data for CWE spotlight slot: {metric_id}")
                                continue
                            ...
                            if "pct" in metric_id or "_pct" in metric_id:
                                ...
                                if pd.isna(raw_value): formatted_value_simple = "N/A"
                                else: formatted_value_simple = f"{raw_value:.1f}"
                            else:  # Integer
                                formatted_value_simple = f"{raw_value:,}"

                        elif isinstance(raw_value, list):
                            if metric_id == "top_3_affected_builds" and raw_value and isinstance(raw_value[0], dict):
                                formatted_value_simple = raw_value[0].get("build", "N/A") if raw_value else "N/A"
                                subtitle_simple = f"{len(raw_value)} builds in list" if raw_value else "No build data"
                            else:
                                formatted_value_simple = f"{len(raw_value)} items"
                        elif isinstance(raw_value, dict):
                            formatted_value_simple = "See Appendix"  # Fallback for other dicts
                        elif isinstance(raw_value, str):
                            formatted_value_simple = raw_value
                        else:
                            try: formatted_value_simple = str(raw_value)
                            except Exception: formatted_value_simple = "Error Formatting"
                    # else raw_value is None, formatted_value_simple remains "N/A"

                # --- Construct the final card dictionary for Jinja ---
                final_card_data_for_jinja = {
                    "id": metric_id,
                    "value": complex_card_structured_value if complex_card_structured_value is not None else formatted_value_simple,
                    "unit": unit_simple if complex_card_structured_value is None else None,
                    "label": label_simple,
                    "subtitle": subtitle_simple,
                    "icon_svg": icon_svg_simple,
                    "trend_value_display": trend_value_display,  # The formatted string like "+5.2%"
                    "trend_direction": trend_direction_final,   # 'up', 'down', 'neutral' or None
    ...
    async def _save_all_metrics(
        ...
        if not metrics_service:
            logger.error("Metrics service is not available. Cannot save metrics.")
            return

        logger.debug(f"Starting to save {len(metrics_data)} metrics for period '{period_key}' from report '{report_name}'.")
        ...
        for metric_key, metric_value in metrics_data.items():
            ...
            if isinstance(metric_value, (int, float)):
                ...
                logger.warning(
                    f"Unsupported metric type for key '{metric_key}' in period '{period_key}': "
                    f"{type(metric_value)}. Skipping this metric."
                )
                continue
            ...
            metric_info_for_dim = {
                "description": f"Metric '{metric_key}' from report '{report_name}' for period '{period_key}'.",
        ...
        for i, result in enumerate(results):
            metric_key = list(metrics_data.keys())[i]  # Get corresponding metric_key, not ideal but works for logging
            if isinstance(result, Exception):
                logger.error(
                    f"Failed to save metric '{metric_key}' for period '{period_key}': {result}"
                )
                failure_count += 1
            elif result is False:  # Assuming upsert_metric_value returns False on logical failure
                logger.warning(
                    f"Saving metric '{metric_key}' for period '{period_key}' reported failure (returned False)."
                )
                failure_count += 1
            else:
                success_count += 1
    ...
    def _prepare_data_for_new_vs_updated_monthly(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        if not all(c in df.columns for c in required_cols):
            logger.warning(f"Missing required columns (need {required_cols}) for 'new_vs_updated' chart.")
            return None

        for col in required_cols:
            if df[col].empty or df[col].isna().all(): # Check if series itself is empty or all NaNs
                logger.warning(f"Required column '{col}' is empty or contains all NaNs for 'new_vs_updated' chart.")
                return None
        ...
        df_copy['published_month_dt_obj'] = pd.to_datetime(df_copy['published_month'], errors='coerce')
        ...
        if df_copy.empty:
            logger.warning("No valid 'published_month' data remains after filtering NaT values. Cannot generate chart data.")
            return None

        df_copy['status'] = pd.Categorical(df_copy['status'], categories=['new', 'updated'], ordered=False)

        # Group by the datetime object for correct chronological grouping
        agg_data = df_copy.groupby(['published_month_dt_obj', 'status'], observed=False).size().reset_index(name='count')

        if agg_data.empty:
            logger.warning("No data after aggregation for 'new_vs_updated' chart (post NaT filter).")
            return None
        ...
        for i, date_val in enumerate(unique_dates):  # date_val is a datetime object
            if i < len(month_display_names):
                ...
                logger.warning(
                    f"More than {len(month_display_names)} unique periods for 'new_vs_updated' chart. "
                    f"Period {i+1} (date: {date_val.strftime('%Y-%m-%d')}) labeled as '{label}'."
                )

        if not date_to_label_map:  # Should not happen if unique_dates is populated
            logger.error("Internal error: No unique dates found to create display labels, though aggregated data was present.")
            return None

        agg_data['month_display_label'] = agg_data['published_month_dt_obj'].map(date_to_label_map)

        # Ensure 'month_display_label' is categorical and ordered correctly for Plotly Express
        ordered_labels = [date_to_label_map[date] for date in unique_dates if date in date_to_label_map]
        ...
        return agg_data[['month_display_label', 'status', 'count']] # Return only necessary columns

    def _prepare_data_for_volume_by_severity_monthly(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        if not all(c in df.columns for c in required_cols):
            logger.warning(f"Missing required columns (need {required_cols}) for 'volume_by_severity_monthly' chart.")
            return None

        for col in required_cols:
            if df[col].empty or df[col].isna().all():
                logger.warning(f"Required column '{col}' is empty or contains all NaNs for 'volume_by_severity_monthly' chart.")
                return None
        ...
        if df_copy.empty:
            logger.warning("No valid 'published_month' data remains after filtering NaT values for 'volume_by_severity_monthly'.")
            return None
        ...
        agg_data = df_copy.groupby(['published_month_dt_obj', 'severity_type'], observed=False).size().reset_index(name='count')

        if agg_data.empty:
            logger.warning("No data after aggregation for 'volume_by_severity_monthly' chart.")
            return None

        # Sort by datetime then by the categorical severity_type
        agg_data = agg_data.sort_values(['published_month_dt_obj', 'severity_type'])
        ...
        for i, date_val in enumerate(unique_dates):
            if i < len(month_display_names):
                ...
                date_to_label_map[date_val] = label
                logger.warning(
                    f"More than {len(month_display_names)} unique periods for 'volume_by_severity_monthly'. "
                    f"Period {i+1} (date: {date_val.strftime('%Y-%m-%d')}) labeled as '{label}'."
                )

        if not date_to_label_map:
            logger.error("Internal error: No unique dates found to create display labels for 'volume_by_severity_monthly'.")
            return None
    ...
    def _prepare_data_for_cvss_distribution(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        if not all(c in df.columns and df[c].notna().any() for c in required_cols):
            logger.warning(f"Missing or empty required columns {required_cols} for 'cvss_distribution'.")
            return None
        df_copy = df.copy()
        # Ensure cve_category column is present and handle fillna before categorizing
        if 'cve_category' not in df_copy.columns: df_copy['cve_category'] = 'none'
        df_copy['cve_category'] = pd.Categorical(df_copy['cve_category'].fillna('none'), categories=self.category_order, ordered=False)

        chart_data = df_copy[['cve_category', 'cvss_score']].dropna(subset=['cvss_score'])
        if chart_data.empty:
            logger.warning("No valid CVSS scores found for 'cvss_distribution'.")
            return None
        chart_data = chart_data.sort_values(by='cve_category')
        return chart_data

    def _prepare_data_for_rce_proportion_monthly(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        if not all(c in df.columns for c in required_cols):
            logger.warning("Missing required columns {required_cols} for 'rce_proportion_monthly'.")
            return None
        ...
        agg_data['proportion'] = (agg_data['rce_count'] / agg_data['total_count'].replace(0, np.nan) * 100).fillna(0)  # Handle division by zero
        return agg_data.reset_index().sort_values('published_month')

    def _prepare_data_for_rce_cvss_distribution(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        required_cols = ['cve_category', 'cvss_score']
        if not all(c in df.columns for c in required_cols):
            logger.warning("Missing required columns {required_cols} for 'rce_cvss_distribution'.")
            return None
        chart_data = df[df['cve_category'] == 'remote_code_execution'][['cvss_score']].dropna().copy()
        if chart_data.empty:
            logger.warning("No valid RCE CVSS scores found for 'rce_cvss_distribution'.")
            return None
        chart_data['category_label'] = 'Remote Code Execution'
        return chart_data

    def _prepare_data_for_eop_proportion_monthly(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        required_cols = ['published_month', 'cve_category']
        if not all(c in df.columns for c in required_cols):
            logger.warning("Missing required columns {required_cols} for 'eop_proportion_monthly'.")
            return None
        total_monthly = df.groupby('published_month', observed=False).size().rename('total_count')
    ...
    def _prepare_data_for_eop_by_attack_vector(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        if not all(c in df.columns for c in required_cols):
            logger.warning("Missing required columns {required_cols} for 'eop_by_attack_vector'.")
            return None
    ...
    def _prepare_data_for_dos_infodisc_monthly(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        """
        required_cols = ['published_month', 'cve_category']
        categories_to_plot = ['denial_of_service', 'disclosure']  # disclosure was 'information_disclosure' earlier, ensure consistency
        if not all(c in df.columns for c in required_cols):
            logger.warning("Missing required columns {required_cols} for 'dos_infodisc_monthly'.")
            return None
        df_filtered = df[df['cve_category'].isin(categories_to_plot)].copy()
        if df_filtered.empty:
            logger.warning("No DoS or Info Disclosure CVEs found for 'dos_infodisc_monthly'.")
            return None
    ...
    def _prepare_data_for_user_interaction_proportion_monthly(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        if not all(c in df.columns for c in required_cols):
            logger.warning("Missing required columns {required_cols} for 'user_interaction_proportion_monthly'.")
            return None
        total_monthly = df.groupby('published_month', observed=False).size().rename('total_count')
    ...
    def _prepare_data_for_overall_attack_vector_dist(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        if not all(c in df.columns for c in required_cols): # Check if col exists
        ...
        if df_copy['attack_vector'].isna().all() or df_copy.empty:
            logger.warning(f"Column 'attack_vector' is empty or all NaN after attempting to fill for '{chart_key}'.")
            return None
        ...
        mapped_av = agg_data['attack_vector'].map(self.attack_vector_display_map)
        agg_data['display_attack_vector'] = mapped_av.fillna(agg_data['attack_vector'].astype(object))
        ...
        ordered_display_labels = [self.attack_vector_display_map.get(key, key) for key in self.attack_vector_order]
        ...
        agg_data = agg_data.sort_values('attack_vector') # Sort by the original key's categorical order

        return agg_data[['attack_vector', 'display_attack_vector', 'percentage']]

    def _prepare_data_for_overall_attack_complexity_dist(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        if not all(c in df.columns and df[c].notna().any() for c in required_cols):
            logger.warning("Missing or empty required columns {required_cols} for 'overall_attack_complexity_dist'.")
            return None
    ...
    def _prepare_data_for_patch_delay_risk_scatter(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        Returns:
            pd.DataFrame | None: DataFrame with 'cve_id', 'days_to_patch', 'cvss_score', and 'cve_category' columns.
                ...
                If the required columns are missing or empty, None is returned instead.
        """
        required_cols = ['published', 'patch_date', 'cvss_score', 'cve_category', 'cve_id']
        if not all(c in df.columns and df[c].notna().any() for c in required_cols):
            logger.warning("Missing or empty required columns {required_cols} for 'patch_delay_risk_scatter'.")
            return None
        df_copy = df.copy()  # Work on a copy to avoid modifying original df passed around

        # Check for essential columns, allow others to be potentially missing but handle them
        if 'published' not in df_copy.columns or 'patch_date' not in df_copy.columns:
            logger.warning("Missing 'published' or 'patch_date' for 'patch_delay_risk_scatter'. Cannot calculate delay.")
            return None

        for col in ['cvss_score', 'cve_category', 'cve_id']:
            if col not in df_copy.columns:
                logger.warning("Column '{col}' missing for 'patch_delay_risk_scatter'. Filling with defaults.")
                if col == 'cvss_score': df_copy[col] = np.nan
                elif col == 'cve_category': df_copy[col] = 'none'  # Not Categorized
                elif col == 'cve_id': df_copy[col] = 'cve-idx-' + pd.Series(df_copy.index).astype(str)

        valid_dates_mask = df_copy['patch_date'].notna() & df_copy['published'].notna()
        df_copy['days_to_patch'] = np.nan
        if valid_dates_mask.any():
            df_copy.loc[valid_dates_mask, 'days_to_patch'] = (df_copy.loc[valid_dates_mask, 'patch_date'] - df_copy.loc[valid_dates_mask, 'published']).dt.days
        df_copy.loc[df_copy['days_to_patch'] < 0, 'days_to_patch'] = 0

        chart_data = df_copy[['cve_id', 'days_to_patch', 'cvss_score', 'cve_category']].copy()
        chart_data.dropna(subset=['days_to_patch', 'cvss_score'], inplace=True)

        if chart_data.empty:
            logger.warning("No valid data points found for 'patch_delay_risk_scatter'.")
            return None
        chart_data['cve_category'] = pd.Categorical(chart_data['cve_category'].fillna('none'), categories=self.category_order, ordered=False)
        return chart_data

    def _prepare_data_for_overall_category_distribution_chart(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        if not all(c in df.columns and df[c].notna().any() for c in required_cols):  # Check if col exists and has at least one non-NA value
            logger.warning(f"Missing or all-NaN required columns {required_cols} for '{chart_key}'.")
            return None
        ...
        mapped_display_cat = category_counts['cve_category'].map(self.category_display_name_map)
        category_counts['display_category'] = mapped_display_cat.fillna(category_counts['cve_category'].astype(object))
        ...
        if category_counts.empty or category_counts['count'].sum() == 0:
            logger.warning(f"No category data with counts found for '{chart_key}'.")
            return None

        # Ensure consistent return variable name
        agg_data = category_counts[['cve_category', 'display_category', 'count']]
        return agg_data

    def _prepare_data_for_attack_vectors_by_privileges_chart(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        df_copy['attack_vector'] = df_copy['attack_vector'].fillna('none')
        df_copy['privileges_required'] = df_copy['privileges_required'].fillna('none')

        if df_copy['attack_vector'].isna().all() or df_copy['privileges_required'].isna().all():
            logger.warning(f"One or more required columns are all NaN after fillna for '{chart_key}'.")
            return None

        # Ensure categorical for ordering and complete categories
        df_copy['attack_vector'] = pd.Categorical(
            df_copy['attack_vector'],
            categories=self.attack_vector_order, ordered=True
        )
        df_copy['privileges_required'] = pd.Categorical(
            df_copy['privileges_required'],
            categories=self.privileges_required_order, ordered=True  # Use defined order
        )

        agg_data = df_copy.groupby(['attack_vector', 'privileges_required'], observed=False).size().reset_index(name='count')

        if agg_data.empty or agg_data['count'].sum() == 0:
            logger.warning(f"No data with counts after aggregation for '{chart_key}'.")
            return None

        # Create display names for x-axis and legend
        mapped_av = agg_data['attack_vector'].map(self.attack_vector_display_map)
        agg_data['display_attack_vector'] = mapped_av.fillna(agg_data['attack_vector'].astype(object))  # Ensure fillna value is not categorical
        mapped_pr = agg_data['privileges_required'].map(self.privileges_required_display_map)
        agg_data['display_privileges_required'] = mapped_pr.fillna(agg_data['privileges_required'].astype(object))  # or .astype(str)
        # Make display columns categorical based on the order of their original keys
        ordered_av_display_labels = [self.attack_vector_display_map.get(key, key) for key in self.attack_vector_order]
        agg_data['display_attack_vector'] = pd.Categorical(
            agg_data['display_attack_vector'],
            categories=ordered_av_display_labels,
            ordered=True
        )
        ordered_pr_display_labels = [self.privileges_required_display_map.get(key, key) for key in self.privileges_required_order]
        ...
        agg_data = agg_data.sort_values(['attack_vector', 'privileges_required'])

        return agg_data[[
            'attack_vector', 'display_attack_vector',
            'privileges_required', 'display_privileges_required',
            'count'
        ]]

    def _prepare_data_for_interaction_vs_complexity_chart(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        required_cols = ['user_interaction', 'attack_complexity', 'cvss_score', 'cve_id']
        ...
        if df_copy.empty:
            logger.info(f"No data remains after filtering 'none' attack_complexity for '{chart_key}'.")
            return None

        # Fill NaNs before converting to categorical
        # Assuming 'none' for user_interaction is valid and 'low'/'high' for complexity
        df_copy['user_interaction'] = df_copy['user_interaction'].fillna('none')
        df_copy['attack_complexity'] = df_copy['attack_complexity'].fillna('low') # Default if NaN after filtering 'none'

        # Ensure all required columns have some non-NA data after filtering and filling
        if not all(df_copy[c].notna().any() for c in required_cols if c in df_copy.columns):
            logger.warning(f"One or more required columns are all NaN after processing for '{chart_key}'.")
            return None

        df_copy['user_interaction'] = pd.Categorical(
            df_copy['user_interaction'],
            categories=self.user_interaction_order, ordered=True
        )
        df_copy['attack_complexity'] = pd.Categorical(
            df_copy['attack_complexity'],
            categories=self.attack_complexity_order, ordered=True # Only 'low', 'high'
        )

        agg_data = df_copy.groupby(['user_interaction', 'attack_complexity'], observed=False).agg(
            count=('cve_id', 'size'),
        ...
        mapped_ui = agg_data['user_interaction'].map(self.user_interaction_display_map)
        agg_data['display_user_interaction'] = mapped_ui.fillna(agg_data['user_interaction'].astype(object))

        mapped_ac = agg_data['attack_complexity'].map(self.attack_complexity_display_map)
        agg_data['display_attack_complexity'] = mapped_ac.fillna(agg_data['attack_complexity'].astype(object))

        return agg_data # user_interaction, attack_complexity, display_user_interaction, display_attack_complexity, count, avg_cvss

    def _prepare_data_for_kev_by_category(self, df: pd.DataFrame) -> pd.DataFrame | None:
        """
        ...
        required_cols = ['cve_category', 'cisa_kev']  # Assumes 'cisa_kev' is boolean or 0/1
        if not all(c in df.columns for c in required_cols):  # Not checking notna for cisa_kev, as it might be sparse
            logger.warning(f"Missing required columns {required_cols} for '{chart_key}'.")
            return None
        if df['cisa_kev'].notna().sum() == 0:  # No KEV data points
            logger.warning(f"No CISA KEV data points found for '{chart_key}'.")
            return pd.DataFrame(columns=['cve_category', 'kev_count'])  # Return empty DF with correct columns

        df_copy = df[df['cisa_kev'] == True].copy()  # Filter for exploited CVEs
        if df_copy.empty:
        ...
        df_copy['cve_category'] = pd.Categorical(
            ...
            categories=self.category_order, ordered=True
        )
        ...
        agg_data = agg_data.set_index('cve_category').reindex(self.category_order, fill_value=0).reset_index()
        return agg_data.sort_values(by='kev_count', ascending=False)

    def _prepare_data_for_cvss_score_by_category_chart(self, df: pd.DataFrame) -> pd.DataFrame | None:
        chart_key = "cvss_score_by_category_box" # Renamed for clarity from generic key
        required_cols = ['cve_category', 'cvss_score']
        if not all(c in df.columns for c in required_cols):
            logger.warning(f"Missing required columns {required_cols} for '{chart_key}'.")
            return None
        ...
        df_copy['cvss_score'] = pd.to_numeric(df_copy['cvss_score'], errors='coerce')
        ...
        if chart_data.empty:
            logger.warning(f"No valid data after processing for '{chart_key}'.")
            return None

        # Add display_cve_category
        mapped_cve_category = chart_data['cve_category'].map(self.category_display_name_map)
        chart_data['display_cve_category'] = mapped_cve_category.fillna(chart_data['cve_category'].astype(object))

        # Make display_cve_category categorical for faceting order
        ordered_cat_display = [self.category_display_name_map.get(k, k) for k in self.category_order]
        ...
        return chart_data[['cve_category', 'display_cve_category', 'cvss_score']].sort_values(by='display_cve_category')

    def _get_cwe_display_label(self, cwe_id_str: str, max_name_len: int = 40) -> str: # Increased max_name_len
    ...
    def _prepare_data_for_top_cwe_spotlight_cards(
        ...
        required_cols = ['cwe_id', 'severity_type', 'cve_category', 'cvss_score', 'cve_id']

        if not all(c in df.columns for c in required_cols):
            missing_cols = [col for col in required_cols if col not in df.columns]
            logger.warning(f"Missing required columns {missing_cols} for '{chart_key}'.")
            return None

        df_copy = df[required_cols].copy()

        high_risk_filter = df_copy['severity_type'].isin(['critical', 'important'])
        df_high_risk = df_copy[high_risk_filter]

        if df_high_risk.empty:
            logger.warning(f"No Critical/Important CVEs found for '{chart_key}'.")
            return []
        ...
        df_cwe_processed = df_high_risk.assign(
            primary_cwe_id=df_high_risk['cwe_id'].astype(str).str.split('[,;]\s*').str[0].str.strip()
        )
        df_cwe_processed = df_cwe_processed[df_cwe_processed['primary_cwe_id'] != '']
        df_cwe_processed.dropna(subset=['primary_cwe_id'], inplace=True)
        # --- End CWE ID Processing ---

        if df_cwe_processed.empty:
            logger.warning(f"No valid primary CWE IDs in Critical/Important CVEs for '{chart_key}'.")
            return []

        # Ensure cvss_score is numeric for aggregation
        df_cwe_processed['cvss_score'] = pd.to_numeric(df_cwe_processed['cvss_score'], errors='coerce')

        cwe_agg = df_cwe_processed.groupby('primary_cwe_id').agg(
            count=('cve_id', 'nunique'), # Count unique CVEs per CWE
            avg_cvss=('cvss_score', 'mean'),
            # Get the mode for cve_category. If ties, mode() returns multiple; take first.
            cve_category_predominant=('cve_category', lambda x: x.mode()[0] if not x.mode().empty else 'none')
        ).reset_index()

        # Sort by count (desc) then by avg_cvss (desc) to break ties for top N
        top_n_cwes_df = cwe_agg.sort_values(by=['count', 'avg_cvss'], ascending=[False, False]).head(top_n)

        if top_n_cwes_df.empty:
            logger.warning(f"No CWEs to display after aggregation for '{chart_key}'.")
            return []
        ...
        for _, row in top_n_cwes_df.iterrows():
            ...
            card = {
                "cwe_id_raw": cwe_id,
                "display_cwe_label": self._get_cwe_display_label(cwe_id),  # e.g., "CWE-79: Cross-site Scripting"
                "count": int(row['count']),
                "avg_cvss": f"{row['avg_cvss']:.1f}" if pd.notna(row['avg_cvss']) else "N/A",
                "predominant_category_raw": pred_cat_raw,
                "display_predominant_category": self.category_display_name_map.get(pred_cat_raw, pred_cat_raw.replace('_', ' ').title())
            }
    ...
    def _prepare_data_for_top_cwe_in_high_risk_cves_chart(
        ...
        required_cols = ['cwe_id', 'severity_type', 'cve_category', 'cvss_score', 'cve_id'] # cve_id for unique count
        if not all(c in df.columns for c in required_cols):
            logger.warning(f"Missing required columns {required_cols} for '{chart_key}'.")
            return None
        ...
        if df_high_risk.empty:
            ...
            return pd.DataFrame(columns=['primary_cwe_id', 'display_cwe_label', 'count',
                                         'avg_cvss', 'cve_category_predominant', 'display_cve_category_predominant'])
        ...
        df_cwe_exploded['primary_cwe_id'] = df_cwe_exploded['primary_cwe_id_list'].str.strip()
        # --- End CWE ID Processing ---

        df_cwe_exploded = df_cwe_exploded.dropna(subset=['primary_cwe_id'])
        df_cwe_exploded = df_cwe_exploded[df_cwe_exploded['primary_cwe_id'] != ''] # Remove empty strings
        ...
        cwe_agg = df_cwe_exploded.groupby('primary_cwe_id').agg(
            count=('cve_id', 'nunique'), # Count unique CVE IDs per CWE
            avg_cvss=('cvss_score', 'mean'),
            cve_category_predominant=('cve_category', lambda x: x.mode()[0] if not x.mode().empty else 'none')
        ).reset_index()

        top_n_cwes_df = cwe_agg.sort_values(by='count', ascending=False).head(top_n)
        ...
        top_n_cwes_df['display_cwe_label'] = top_n_cwes_df['primary_cwe_id'].apply(get_cwe_display_label)

        # Add display name for predominant category
        top_n_cwes_df['display_cve_category_predominant'] = top_n_cwes_df['cve_category_predominant'].map(
            self.category_display_name_map
        ...
        ordered_cwe_display_labels = top_n_cwes_df.sort_values('count', ascending=True)['display_cwe_label'].tolist() # Ascending for y-axis order
        top_n_cwes_df['display_cwe_label'] = pd.Categorical(top_n_cwes_df['display_cwe_label'], categories=ordered_cwe_display_labels, ordered=True)

        ordered_predominant_cat_display = [self.category_display_name_map.get(k,k) for k in self.category_order]
    ...
    def _prepare_data_for_top_windows_versions_by_criticality_chart(
        ...
        if not all(c in df.columns for c in required_cols):
            missing_cols = [col for col in required_cols if col not in df.columns]
            logger.warning(f"Missing columns {missing_cols} from input df for '{chart_key}'.")
            return None

        # Ensure severity_type is present and has some data
        if 'severity_type' not in df.columns or df['severity_type'].isna().all():
            logger.warning(f"Column 'severity_type' is missing or all NaN for '{chart_key}'.")
            return None
        ...
        if df_exploded is None or df_exploded.empty:
            logger.warning(
                f"Helper '_get_exploded_standardized_products' returned None or empty DataFrame for '{chart_key}'."
            )
            return pd.DataFrame() # Or return pd.DataFrame() if an empty DF is expected by callers
        ...
        if 'standardized_product' in df_exploded.columns:
            df_exploded.rename(
                columns={'standardized_product': 'windows_edition_version_arch'},
                inplace=True
            )
        else:
            logger.warning(
                f"Expected 'standardized_product' column not found in DataFrame returned by helper for '{chart_key}'."
            )
            return pd.DataFrame()
        ...
        if df_exploded.empty or 'windows_edition_version_arch' not in df_exploded.columns or df_exploded['windows_edition_version_arch'].isna().all():
            logger.warning(f"No valid 'windows_edition_version_arch' after processing with helper for '{chart_key}'.")
            return pd.DataFrame()
        ...
        severity_map = {
            'critical': 'Critical', 'high': 'High',
            'medium': 'Medium/Low', 'low': 'Medium/Low', 'none': 'Other/None'
        }
        df_exploded['display_severity'] = df_exploded['severity_type'].map(severity_map).fillna('Other/None')

        display_severity_order = ['Critical', 'High', 'Medium/Low', 'Other/None']
        ...
        product_severity_counts_df = df_exploded.groupby(
            ['windows_edition_version_arch', 'display_severity'],
            observed=False
        )['cve_id'].nunique().unstack(fill_value=0)

        if product_severity_counts_df.empty:
            logger.warning(f"No product data after grouping for '{chart_key}'.")
            return None
        ...
        product_severity_counts_df['critical_high_sum'] = \
            product_severity_counts_df.get('Critical', 0) + product_severity_counts_df.get('High', 0)

        top_n_products_df = product_severity_counts_df.sort_values(
            by=['critical_high_sum', 'Critical', 'High'], # Secondary sort by Critical, then High
            ascending=[False, False, False]
        ).head(top_n)

        if top_n_products_df.empty:
            logger.warning(f"No top N product data to display for '{chart_key}'.")
            return None

        columns_to_melt = [col for col in display_severity_order if col in top_n_products_df.columns]
        chart_data = top_n_products_df[columns_to_melt].reset_index().melt(
        ...
        return chart_data.sort_values(['windows_edition_version_arch', 'severity_group'])

    def _prepare_data_for_days_to_nvd_by_severity_boxplots(self, df: pd.DataFrame) -> pd.DataFrame | None:
        chart_key = "days_to_nvd_by_severity_vbox"
        required_cols = ['published', 'patch_date', 'severity_type']
        if not all(c in df.columns for c in required_cols):
            logger.warning(f"Missing one or more required columns {required_cols} for '{chart_key}'.")
            return None
        ...
        df_copy['patch_date'] = pd.to_datetime(df_copy['patch_date'], errors='coerce')

        # Calculate days_to_nvd. Allow negative values.
        valid_dates_mask = df_copy['patch_date'].notna() & df_copy['published'].notna()
        if not valid_dates_mask.any():
            logger.warning(f"No valid date pairs (published, patch_date) for '{chart_key}'.")
            return None

        df_copy['days_to_nvd'] = np.nan
        df_copy.loc[valid_dates_mask, 'days_to_nvd'] = \
            (df_copy.loc[valid_dates_mask, 'patch_date'] - df_copy.loc[valid_dates_mask, 'published']).dt.days
        ...
        if chart_data.empty:
            logger.warning(f"No data points for '{chart_key}' after processing dates and NaNs.")
            return None

        # Add display_severity_type
        chart_data['display_severity_type'] = chart_data['severity_type'].map(
            self.severity_display_name_map
        ).fillna(chart_data['severity_type'])

        # Make display_severity_type categorical for X-axis ordering
        ordered_severity_display = [self.severity_display_name_map.get(k, k) for k in self.severity_order]
        ...
        return chart_data[['severity_type', 'display_severity_type', 'days_to_nvd']].sort_values(by='display_severity_type')

    def _prepare_data_for_spotlight_cves_base(self, df: pd.DataFrame, top_n: int = 10) -> pd.DataFrame | None:
        ...
        required_for_sort = ['attack_vector', 'attack_complexity', 'privileges_required', 'user_interaction']
        # Optional for sorting
        optional_for_sort = ['cisa_kev']

        all_possible_cols = required_for_plot + required_for_sort + optional_for_sort
        ...
        for col in required_for_plot:
            if col not in df_copy.columns:
                if col == 'cvss_score': df_copy[col] = 0.0
                elif col == 'cve_id': df_copy[col] = "CVE-UNKNOWN" # Placeholder
                else: df_copy[col] = "N/A"

        # For sorting columns, fill NA more robustly before mapping
        for col in required_for_sort:
            if col not in df_copy.columns: df_copy[col] = 'n/a' # Default for missing sort factor
            else: df_copy[col] = df_copy[col].fillna('n/a')
        ...
        if 'cisa_kev' in df_copy.columns: # Check if it actually exists after potential creation
        ...
        av_map = {'network': 0, 'adjacent_network': 1, 'local': 2, 'physical': 3, 'none': 4, 'n/a': 4}
        ac_map = {'low': 0, 'high': 1, 'n/a': 2}
        pr_map = {'none': 0, 'low': 1, 'high': 2, 'n/a': 3}
        ui_map = {'none': 0, 'required': 1, 'n/a': 2}

        df_copy['av_sort'] = df_copy['attack_vector'].str.lower().map(av_map).fillna(max(av_map.values()))
        df_copy['ac_sort'] = df_copy['attack_complexity'].str.lower().map(ac_map).fillna(max(ac_map.values()))
        df_copy['pr_sort'] = df_copy['privileges_required'].str.lower().map(pr_map).fillna(max(pr_map.values()))
        df_copy['ui_sort'] = df_copy['user_interaction'].str.lower().map(ui_map).fillna(max(ui_map.values()))
        ...
        df_copy['cvss_score'] = pd.to_numeric(df_copy['cvss_score'], errors='coerce').fillna(0.0)

        spotlight_df = df_copy.sort_values(by=sort_columns, ascending=ascending_order).head(top_n)
        ...
        final_spotlight_df = spotlight_df[plot_cols].copy() # .copy() to avoid warnings on next step

        # Ensure cve_id is string for y-axis category
        final_spotlight_df['cve_id'] = final_spotlight_df['cve_id'].astype(str)

        return final_spotlight_df.sort_values(by='cvss_score', ascending=False) # Final sort for plot order

    def _prepare_data_for_cat_av_pr_chart(self, df: pd.DataFrame) -> pd.DataFrame | None:
        chart_key = "cat_av_pr_chart"
        required_cols = ['cve_category', 'attack_vector', 'privileges_required', 'cve_id']
        if not all(c in df.columns for c in required_cols): # Simpler check for column existence
            logger.warning(f"Missing required columns {required_cols} for '{chart_key}'.")
            return None
        ...
        df_copy['cve_category'] = pd.Categorical(df_copy['cve_category'], categories=self.category_order, ordered=True)
        df_copy['attack_vector'] = pd.Categorical(df_copy['attack_vector'], categories=self.attack_vector_order, ordered=True)
        df_copy['privileges_required'] = pd.Categorical(df_copy['privileges_required'], categories=self.privileges_required_order, ordered=True)

        agg_data = df_copy.groupby(
        ...
        mapped_cve_category = agg_data['cve_category'].map(self.category_display_name_map)
        agg_data['display_cve_category'] = mapped_cve_category.fillna(agg_data['cve_category'].astype(object))

        mapped_av = agg_data['attack_vector'].map(self.attack_vector_display_map)
        agg_data['display_attack_vector'] = mapped_av.fillna(agg_data['attack_vector'].astype(object))

        mapped_pr = agg_data['privileges_required'].map(self.privileges_required_display_map)
        agg_data['display_privileges_required'] = mapped_pr.fillna(agg_data['privileges_required'].astype(object))

        # Make display columns categorical based on the order of their original keys
        # This ensures Plotly plots them in the desired order when used for axes/facets/colors
        ordered_cat_display = [self.category_display_name_map.get(k, k) for k in self.category_order]
        agg_data['display_cve_category'] = pd.Categorical(agg_data['display_cve_category'], categories=ordered_cat_display, ordered=True)

        ordered_av_display = [self.attack_vector_display_map.get(k, k) for k in self.attack_vector_order]
        agg_data['display_attack_vector'] = pd.Categorical(agg_data['display_attack_vector'], categories=ordered_av_display, ordered=True)

        ordered_pr_display = [self.privileges_required_display_map.get(k, k) for k in self.privileges_required_order]
        agg_data['display_privileges_required'] = pd.Categorical(agg_data['display_privileges_required'], categories=ordered_pr_display, ordered=True)
        logger.info(f"Aggregated data for '{chart_key}': {agg_data.head()}")
        return agg_data.sort_values(['cve_category', 'attack_vector', 'privileges_required'])

    def _prepare_data_for_cat_ui_ac_chart(self, df: pd.DataFrame) -> pd.DataFrame | None:
        chart_key = "cat_ui_ac_chart"
        required_cols = ['cve_category', 'user_interaction', 'attack_complexity', 'cve_id']
        if not all(c in df.columns for c in required_cols):
            logger.warning(f"Missing required columns {required_cols} for '{chart_key}'.")
            return None
        ...
        df_copy['attack_complexity'] = df_copy['attack_complexity'].fillna('low')

        # Filter attack_complexity to only include 'low' and 'high' if other values might exist
        df_copy = df_copy[df_copy['attack_complexity'].isin(self.attack_complexity_order)]

        if not all(df_copy[c].notna().any() for c in required_cols if c in df_copy.columns):
            logger.warning(f"One or more required columns are all NaN after fillna/filtering for '{chart_key}'.")
            return None
        if df_copy.empty:
            logger.warning(f"DataFrame is empty after pre-processing for '{chart_key}'.")
            return None

        df_copy['cve_category'] = pd.Categorical(df_copy['cve_category'], categories=self.category_order, ordered=True)
        df_copy['user_interaction'] = pd.Categorical(df_copy['user_interaction'], categories=self.user_interaction_order, ordered=True)
        df_copy['attack_complexity'] = pd.Categorical(df_copy['attack_complexity'], categories=self.attack_complexity_order, ordered=True)
        ...
        ordered_ui_display = [self.user_interaction_display_map.get(k, k) for k in self.user_interaction_order]
        agg_data['display_user_interaction'] = pd.Categorical(agg_data['display_user_interaction'], categories=ordered_ui_display, ordered=True)

        ordered_ac_display = [self.attack_complexity_display_map.get(k, k) for k in self.attack_complexity_order]
        agg_data['display_attack_complexity'] = pd.Categorical(agg_data['display_attack_complexity'], categories=ordered_ac_display, ordered=True)

        logger.info(f"Aggregated data for '{chart_key}': {agg_data.head()}")
        return agg_data.sort_values(['cve_category', 'user_interaction', 'attack_complexity'])

    def _prepare_data_for_top_cwe_av_cvss_chart(self, df: pd.DataFrame, top_n_cwes_val: int = 5) -> pd.DataFrame | None:
        chart_key = "top_cwe_av_cvss_boxplot"
        required_cols = ['cwe_id', 'attack_vector', 'cvss_score', 'cve_id']  # cve_id for counting top CWEs
        if not all(c in df.columns for c in required_cols):
            logger.warning(f"Missing required columns {required_cols} for '{chart_key}'.")
            return None
        ...
        if df_copy['cwe_id'].dtype == 'object' and df_copy['cwe_id'].str.contains('[,;]', na=False).any():
            cwe_counts_df = df_copy.assign(
                parsed_cwe=df_copy['cwe_id'].str.split('[,;]\s*')
            ).explode('parsed_cwe')
            cwe_counts_df['parsed_cwe'] = cwe_counts_df['parsed_cwe'].str.strip()
        ...
        if cwe_counts_df.empty:
            logger.warning(f"No CWE data available to determine top CWEs for '{chart_key}'.")
            return None

        top_cwe_ids = cwe_counts_df['parsed_cwe'].value_counts().nlargest(top_n_cwes_val).index.tolist()
        if not top_cwe_ids:
            logger.warning(f"Could not determine Top {top_n_cwes_val} CWEs for '{chart_key}'.")
            return None
        ...
        def contains_top_cwe(cwe_string):
            if pd.isna(cwe_string): return False
            current_cwes = {c.strip() for c in str(cwe_string).split('[,;]\s*')}
            return any(top_cwe in current_cwes for top_cwe in top_cwe_ids)

        df_filtered_for_top_cwes = df_copy[df_copy['cwe_id'].apply(contains_top_cwe)].copy() # .copy() to avoid SettingWithCopyWarning

        if df_filtered_for_top_cwes.empty:
            logger.warning(f"No CVEs found associated with the top CWEs for '{chart_key}'.")
            return None
        ...
        for index, row in df_filtered_for_top_cwes.iterrows():
            ...
            current_row_cwes = {c.strip() for c in str(row['cwe_id']).split('[,;]\s*')}
            for top_cwe_id_str in top_cwe_ids:
                if top_cwe_id_str in current_row_cwes:
                    chart_data_list.append({
                        'primary_cwe_id': top_cwe_id_str, # This will be our facet
                        'attack_vector': attack_vector,
                        'cvss_score': cvss_score
                    })

        if not chart_data_list:
            logger.warning(f"No data points generated for top CWEs for '{chart_key}'.")
            return None

        chart_data = pd.DataFrame(chart_data_list)

        chart_data['attack_vector'] = chart_data['attack_vector'].fillna('none')
        chart_data = chart_data.dropna(subset=['primary_cwe_id', 'attack_vector', 'cvss_score'])
        # Ensure cvss_score is numeric
        chart_data['cvss_score'] = pd.to_numeric(chart_data['cvss_score'], errors='coerce').dropna()

        if chart_data.empty:
            logger.warning(f"No valid data points after final cleaning for '{chart_key}'.")
            return None

        # Add display names
        chart_data['display_primary_cwe_id'] = chart_data['primary_cwe_id'].apply(self._get_cwe_display_label)
        mapped_av = chart_data['attack_vector'].map(self.attack_vector_display_map)
        chart_data['display_attack_vector'] = mapped_av.fillna(chart_data['attack_vector'].astype(object))

        # Categorical ordering
        # Order facets by the original top_cwe_ids order (which was by frequency)
        ordered_cwe_display_labels = [self._get_cwe_display_label(cwe_id) for cwe_id in top_cwe_ids]
        chart_data['display_primary_cwe_id'] = pd.Categorical(chart_data['display_primary_cwe_id'], categories=ordered_cwe_display_labels, ordered=True)

        ordered_av_display_labels = [self.attack_vector_display_map.get(k, k) for k in self.attack_vector_order]
        chart_data['display_attack_vector'] = pd.Categorical(chart_data['display_attack_vector'], categories=ordered_av_display_labels, ordered=True)

        # Sort for consistent plot generation if needed, though category_orders handles it mostly
        return chart_data.sort_values(['display_primary_cwe_id', 'display_attack_vector'])

    def _get_cluster_characterization(self, df_cluster: pd.DataFrame, categorical_features: list) -> dict:
        ...
        # CVSS Profile
        if 'cvss_score' in df_cluster.columns and df_cluster['cvss_score'].notna().any():
            cvss_desc = df_cluster['cvss_score'].describe().to_dict()
            char_dict["cvss_profile"] = {k: round(v, 2) if isinstance(v, float) else v for k, v in cvss_desc.items()}
        else:
        ...
        for feat in categorical_features:
            if feat in df_cluster.columns and df_cluster[feat].notna().any():
                counts = df_cluster[feat].value_counts(normalize=True).mul(100).round(1)
                # Get display name for the feature values using the maps
                display_counts = {}
                if feat == 'cve_category': mapper = self.category_display_name_map
                elif feat == 'attack_vector': mapper = self.attack_vector_display_map
                elif feat == 'attack_complexity': mapper = self.attack_complexity_display_map
                elif feat == 'privileges_required': mapper = self.privileges_required_display_map
                elif feat == 'user_interaction': mapper = self.user_interaction_display_map
                else: mapper = {}

                for val, perc in counts.items():
                    display_val = mapper.get(val, str(val))  # Fallback to original value
                    display_counts[display_val] = perc
                cat_profiles[feat] = dict(sorted(display_counts.items(), key=lambda item: item[1], reverse=True)[:3]) # Top 3
            else:
                cat_profiles[feat] = {"top_value": "N/A"}
        char_dict["categorical_profiles"] = cat_profiles
        return char_dict

    def _attempt_automated_cluster_name(self, char_dict: dict, cluster_numeric_id: int) -> str:
        ...
        if isinstance(cvss_median, (int, float)):
            if cvss_median >= 8.0: parts.append("V.High CVSS")
            elif cvss_median >= 7.0: parts.append("High CVSS")
            elif cvss_median >= 4.0: parts.append("Med CVSS")
            else: parts.append("Low CVSS")

        # Top Category (already a display name from _get_cluster_characterization)
        cat_profile = char_dict.get("categorical_profiles", {}).get("cve_category", {})
        if cat_profile:
            top_cat_display_name = list(cat_profile.keys())[0]
            # --- Local Shortening for Auto-Name String ---
            if "Remote Code Execution" in top_cat_display_name: short_cat_name = "RCE"
            elif "Privilege Elevation" in top_cat_display_name: short_cat_name = "EoP"
            elif "Information Disclosure" in top_cat_display_name: short_cat_name = "Info. Disc."
            elif "Denial of Service" in top_cat_display_name: short_cat_name = "DoS"
            else: short_cat_name = top_cat_display_name  # Use full display name if no short version
            parts.append(short_cat_name)

        # Top Attack Vector (already a display name)
        av_profile = char_dict.get("categorical_profiles", {}).get("attack_vector", {})
        if av_profile:
            top_av_display_name = list(av_profile.keys())[0]
            if "Unknown" not in top_av_display_name and "None" not in top_av_display_name:
                parts.append(f"{top_av_display_name} Vector")
            else:
                parts.append(top_av_display_name)  # e.g. "Unknown AV" or "None AV"
    ...
    def _prepare_data_for_tsne_cve_profile_chart(
        ...
        categorical_features_raw = ['attack_vector', 'attack_complexity', 'privileges_required', 'user_interaction', 'cve_category']
        required_cols = base_features + categorical_features_raw + ['cve_id']

        if not all(c in df.columns for c in required_cols):
            missing = [c for c in required_cols if c not in df.columns]
            logger.warning(f"Missing required columns {missing} for '{chart_key}'. Cannot proceed.")
            return None

        df_original_context = df[required_cols].copy()
        # Ensure cvss_score is numeric before dropping NaNs based on it
        df_original_context['cvss_score'] = pd.to_numeric(df_original_context['cvss_score'], errors='coerce')
        ...
        for col in categorical_features_raw:
            ...
            df_original_context[col] = df_original_context[col].fillna('unknown')

        min_samples_for_tsne = max(n_clusters + 1, 15)  # Smallest reasonable sample size
        if df_original_context.empty or len(df_original_context) < min_samples_for_tsne:
            logger.warning(f"Not enough data points ({len(df_original_context)}, need at least {min_samples_for_tsne}) for t-SNE/clustering for '{chart_key}'.")
            return None

        preprocessor = ColumnTransformer(
            transformers=[
                ('num', StandardScaler(), base_features),
                ('cat', OneHotEncoder(handle_unknown='ignore', sparse_output=False), categorical_features_raw)
            ], remainder='drop')

        feature_matrix = preprocessor.fit_transform(df_original_context.drop(columns=['cve_id']))

        if feature_matrix.shape[0] == 0:
            logger.warning(f"Feature matrix is empty after preprocessing for '{chart_key}'.")
            return None

        kmeans = KMeans(n_clusters=n_clusters, random_state=42, n_init='auto')
        cluster_labels_numeric = kmeans.fit_predict(feature_matrix)  # These are 0, 1, 2...

        # --- Characterization, Naming, and Saving ---
        actual_stats_to_save = {}    # Will hold detailed stats for JSON, keyed by "Profile Group X (Numeric ID Y)"
        final_names_for_plot = {}       # Maps numeric_id (0,1,2..) to final display name for the plot
        ...
        for i in range(n_clusters):  # i is the numeric cluster ID: 0, 1, 2...
            df_cluster_subset = temp_df_for_char_analysis[temp_df_for_char_analysis['cluster_numeric'] == i]

            characterization_data_for_cluster_i = self._get_cluster_characterization(df_cluster_subset, categorical_features_raw)

            # Key for JSON: User-friendly 1-indexed, plus original 0-indexed for clarity
            json_key = f"Profile Group {i+1} (Internal ID {i})"
            actual_stats_to_save[json_key] = characterization_data_for_cluster_i

            # Determine the display name for this cluster for the plot
            manual_name = self.MANUAL_CLUSTER_NAMES.get(i)  # Check manual overrides (0-indexed key)
            if manual_name:
                current_cluster_plot_name = manual_name
            else:
                current_cluster_plot_name = self._attempt_automated_cluster_name(characterization_data_for_cluster_i, i)

            final_names_for_plot[i] = current_cluster_plot_name  # Store final name for numeric ID i

        # Save the DETAILED CHARACTERIZATION STATISTICS
        if actual_stats_to_save and data_output_dir:  # Use passed data_output_dir
            try:
                ...
                if hasattr(self, 'run_identifier') and self.run_identifier:
                    ...
                    if len(run_id_parts) >= 7: # Expecting at least 7 parts for the full date range
                        ...
                        date_timestamp_str = f"{start_month}{start_year}_{end_month}{end_year}"
                        dynamic_filename = f"cluster_characterization_{date_timestamp_str}.json"
                    # --- END CORRECTION ---
                    else:
                        logger.warning(
                            f"self.run_identifier ('{self.run_identifier}') does not have the expected "
                            f"number of parts (found {len(run_id_parts)}, expected >= 7) for detailed date extraction. "
                            f"Using default filename for cluster characterization."
                        )

                # Ensure the data_output_dir itself exists
                os.makedirs(data_output_dir, exist_ok=True)

                char_file_path = os.path.join(data_output_dir, dynamic_filename)

                with open(char_file_path, 'w') as f:
                    json.dump(actual_stats_to_save, f, indent=2)

                logger.info(f"Cluster characterization statistics saved to {char_file_path}")
            except Exception as e:
                logger.error(f"Failed to save cluster characterization statistics: {e}")
        # --- End Characterization, Naming, Saving ---

        # --- t-SNE Transformation ---
        # Your existing perplexity calculation - ensure it's robust
        tsne_perplexity = min(30, max(1, len(df_original_context) - 2, n_clusters))  # Max perplexity is n_samples - 1. Ensure > 0.
        if tsne_perplexity >= len(df_original_context):
            tsne_perplexity = max(1, len(df_original_context) - 1)  # Clamp if too high
        if tsne_perplexity == 0 and len(df_original_context) > 1:  # Handle edge case if samples = 1
            tsne_perplexity = 1

        if len(df_original_context) <= tsne_perplexity :  # Scikit-learn constraint
            tsne_perplexity = max(1, len(df_original_context) - 1)
            if tsne_perplexity == 0:  # if only 1 sample
                logger.warning(f"Only {len(df_original_context)} sample(s), t-SNE cannot run with perplexity. Skipping t-SNE.")
                ...
                tsne = TSNE(n_components=2, random_state=42, perplexity=tsne_perplexity, n_iter=250, init='pca', learning_rate='auto') # Reduced n_iter
                tsne_results = tsne.fit_transform(feature_matrix)
                df_tsne_plot = pd.DataFrame(tsne_results, columns=['tsne_x', 'tsne_y'], index=df_original_context.index)
        else:
            tsne = TSNE(n_components=2, random_state=42, perplexity=tsne_perplexity, n_iter=250, init='pca', learning_rate='auto')
            tsne_results = tsne.fit_transform(feature_matrix)
            df_tsne_plot = pd.DataFrame(tsne_results, columns=['tsne_x', 'tsne_y'], index=df_original_context.index)

        df_tsne_plot['cluster_numeric'] = cluster_labels_numeric
        df_tsne_plot['cluster_label'] = df_tsne_plot['cluster_numeric'].map(final_names_for_plot)
    ...
    def _prepare_chart_data(
        ...
        **chart_specific_params
        ...
        if df.empty:
            logger.warning(f"DataFrame is empty for chart '{chart_key}'. Returning None.")
            return None

        handler_method: Optional[Callable[..., Any]] = self.CHART_DATA_HANDLERS.get(chart_key)

        if handler_method:
            try:
                logger.info(f"Using handler: {handler_method.__name__} for chart '{chart_key}'")
                ...
                if 'data_output_dir' in handler_params and data_output_dir is not None:
                ...
                if chart_specific_params:
                    for param_name, param_value in chart_specific_params.items():
                ...
                logger.exception(
                    f"Error executing handler '{handler_method.__name__}' for chart '{chart_key}': {e}"
                )
                return None
        else:
            logger.warning(f"No data preparation handler defined for chart key '{chart_key}'. Returning None.")
            return None
    # ------------------------------------------------------------------------------
    ...
    def _plot_new_vs_updated_monthly(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        """
        ...
        if chart_data is None or chart_data.empty:
            logger.info(f"No data provided to _plot_new_vs_updated_monthly for title '{title}'. Cannot generate chart.")
            return None

        if 'month_display_label' not in chart_data.columns or chart_data['month_display_label'].isna().all():
            logger.error("Critical: 'month_display_label' column is missing or all NaN in chart_data for _plot_new_vs_updated_monthly. Cannot generate chart correctly.")
            return None
        ...
        if pd.isna(max_y_value) or max_y_value <= 0:
            ...
            y_axis_upper_limit = max_y_value * 1.15  # Add 15% padding for text labels
        ...
        fig.update_layout(
            ...
            yaxis_range=[0, y_axis_upper_limit], # Apply calculated y-axis range
            legend_title_text='Status' # Set a title for the legend
        )

        return fig

    def _plot_volume_by_severity_monthly(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        """
        ...
        """
        if chart_data is None or chart_data.empty:
            logger.info(f"No data provided to _plot_volume_by_severity_monthly for title '{title}'.")
            return None

        required_plot_cols = ['month_display_label', 'severity_type', 'count']
        if not all(c in chart_data.columns for c in required_plot_cols):
            logger.error(f"Chart data is missing required columns {required_plot_cols} for _plot_volume_by_severity_monthly.")
            return None

        if chart_data['month_display_label'].isna().all():
            logger.error("Critical: 'month_display_label' column is all NaN in chart_data for _plot_volume_by_severity_monthly.")
            return None
        ...
        fig = px.bar(
            ...
            labels={
                'month_display_label': 'Month',
                'count': 'Number of CVEs',
                'severity_type': 'Severity'  # This will be used by legend unless overridden
            },
            category_orders={"severity_type": self.severity_order},  # Uses self.severity_order
        ...
        fig.update_layout(
            ...
            margin=dict(t=60, b=50, l=50, r=20)  # Adjusted top margin for title, right for legend
        )

        return fig

    def _plot_cvss_distribution(self, chart_data: pd.DataFrame, title: str) -> go.Figure:
        fig = px.violin(
            chart_data, x='cve_category', y='cvss_score',
            labels={'cve_category': 'Vulnerability Category', 'cvss_score': 'CVSS Base Score'},
            category_orders={"cve_category": self.category_order},
            color="cve_category", color_discrete_map=self.category_color_map,
            box=True, points='outliers'
        )
        fig.update_layout(showlegend=False)
        return fig

    def _plot_rce_proportion_monthly(self, chart_data: pd.DataFrame, title: str) -> go.Figure:
        fig = px.line(
            chart_data, x='published_month', y='proportion',
            labels={'published_month': 'Month', 'proportion': '% of Total CVEs'},
            markers=True
        )
        fig.update_layout(yaxis_range=[0, max(10, chart_data['proportion'].max() * 1.1 if not chart_data.empty and chart_data['proportion'].max() > 0 else 10)],
                          yaxis_ticksuffix="%")
        return fig

    def _plot_rce_cvss_distribution(self, chart_data: pd.DataFrame, title: str) -> go.Figure:
        fig = px.violin(
            chart_data, x='category_label', y='cvss_score',
    ...
    def _plot_eop_proportion_monthly(self, chart_data: pd.DataFrame, title: str) -> go.Figure:
        fig = px.line(
            chart_data, x='published_month', y='proportion',
            labels={'published_month': 'Month', 'proportion': '% of Total CVEs'},
            markers=True
    ...
    def _plot_eop_by_attack_vector(self, chart_data: pd.DataFrame, title: str) -> go.Figure:
        fig = px.bar(
            chart_data, x='attack_vector', y='count',
    ...
    def _plot_dos_infodisc_monthly(self, chart_data: pd.DataFrame, title: str) -> go.Figure:
        fig = px.bar(
            chart_data, x='published_month', y='count', color='category_display',
            ...
            color_discrete_map={
                ...
                'Info Disclosure': self.category_color_map.get('disclosure', '#67C2C0')  # Ensure 'disclosure' key exists in map
            },
    ...
    def _plot_user_interaction_proportion_monthly(self, chart_data: pd.DataFrame, title: str) -> go.Figure:
        fig = px.line(
            chart_data, x='published_month', y='proportion_required',
    ...
    def _plot_overall_attack_vector_dist(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        """
        ...
        """
        if chart_data is None or chart_data.empty:
            logger.info(f"No data provided to _plot_overall_attack_vector_dist for title '{title}'.")
            return None

        required_plot_cols = ['attack_vector', 'display_attack_vector', 'percentage']
        if not all(c in chart_data.columns for c in required_plot_cols):
            logger.error(f"Chart data is missing required columns {required_plot_cols} for attack vector distribution.")
            return None
        ...
        fig = px.bar(
            ...
            labels={
                'display_attack_vector': 'Attack Vector',  # Label for the x-axis itself
                'percentage': '% of Total CVEs',
                'attack_vector': 'Attack Vector Type'  # Label for legend/hover if color is shown
            },
    ...
    def _plot_overall_attack_complexity_dist(self, chart_data: pd.DataFrame, title: str) -> go.Figure:
        fig = px.bar(
            chart_data, x='attack_complexity', y='percentage',
            labels={'attack_complexity': 'Attack Complexity', 'percentage': '% of Total CVEs'},
            category_orders={"attack_complexity": self.attack_complexity_order},
            text_auto='.1f'
        )
    ...
    def _plot_patch_delay_risk_scatter(self, chart_data: pd.DataFrame, title: str) -> go.Figure:
        fig = px.scatter(
            chart_data, x='days_to_patch', y='cvss_score',
    ...
    def _plot_overall_category_distribution_chart(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        """
        ...
        """
        if chart_data is None or chart_data.empty:
            logger.info(f"No data provided to _plot_overall_category_distribution_chart for title '{title}'.")
            return None

        required_plot_cols = ['cve_category', 'display_category', 'count']
        if not all(c in chart_data.columns for c in required_plot_cols):
            logger.error(f"Chart data missing required columns {required_plot_cols} for overall category distribution.")
            return None

        fig = px.treemap(
            chart_data,
            path=[px.Constant("All Categories"), 'display_category'],  # Use display_category for path
            values='count',
            color='cve_category',                 # Color by original 'cve_category' to use the map keys
            color_discrete_map=self.category_color_map,
            custom_data=['display_category', 'count']  # Add data for hover/text
        )
        ...
        # Percentage (Larger)
        fig.update_traces(
            texttemplate="<b>%{label}</b><br>%{customdata[1]}<br>%{percentRoot:.0%}",
            textfont_size=12,  # Base size, can be overridden by HTML tags if needed
            textposition='middle center',
            insidetextfont=dict(size=14, color='white'),  # Increase size of text inside the tiles
    ...
    def _plot_attack_vectors_by_privileges_chart(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        """Generates a stacked bar chart for Attack Vectors by Privileges Required."""
        if chart_data is None or chart_data.empty:
            logger.info(f"No data provided to _plot_attack_vectors_by_privileges_chart for '{title}'.")
            return None

        # Ensure all required display columns for plotting are present
        required_plot_cols = ['display_attack_vector', 'display_privileges_required', 'count']
        if not all(c in chart_data.columns for c in required_plot_cols):
            missing_cols = [col for col in required_plot_cols if col not in chart_data.columns]
            logger.error(f"Chart data for '{title}' missing required plot columns: {missing_cols}")
            # Return an error figure or None
            fig = go.Figure(); fig.update_layout(title_text=title, title_x=0.5, height=300)
            fig.add_annotation(text=f"Plot data misconfigured. Missing: {', '.join(missing_cols)}", showarrow=False)
            return fig
        ...
        fig = px.bar(
            ...
            labels={
                'display_attack_vector': 'Attack Vector', 'count': 'Number of CVEs',
                'display_privileges_required': 'Privileges Required'
            },
            category_orders={
                "display_attack_vector": [self.attack_vector_display_map.get(k, k) for k in self.attack_vector_order],
                "display_privileges_required": [self.privileges_required_display_map.get(k, k) for k in self.privileges_required_order]
            },
        ...
        if not chart_data.empty:
            max_stacked_height = chart_data.groupby('display_attack_vector')['count'].sum().max()
        ...
        fig.update_layout(
            ...
            legend=dict(
                orientation="h",
                yanchor="top", y=0.98, # Position below plot
            ...
            margin=dict(l=70, r=40, t=80, b=150), # Increased bottom margin for legend
    ...
    def _plot_interaction_vs_complexity_chart(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        """Generates a heatmap for User Interaction vs. Attack Complexity with improved text and layout."""
        if chart_data is None or chart_data.empty:
            # ... (error handling) ...
            logger.info(f"No data for _plot_interaction_vs_complexity_chart with title '{title}'.")
            fig = go.Figure()
            fig.update_layout(title_text=title, title_x=0.5, height=300)
            fig.add_annotation(text="No data to display for heatmap.", showarrow=False)
            return fig

        try:
            ordered_y_display = [self.user_interaction_display_map.get(k, k) for k in self.user_interaction_order]
            ordered_x_display = [self.attack_complexity_display_map.get(k, k) for k in self.attack_complexity_order]

            heatmap_data_count = chart_data.pivot_table(
                index='display_user_interaction', columns='display_attack_complexity',
                values='count', aggfunc='sum'
            ).reindex(index=ordered_y_display, columns=ordered_x_display, fill_value=0)

            heatmap_data_avg_cvss = chart_data.pivot_table(
                index='display_user_interaction', columns='display_attack_complexity',
                values='avg_cvss', aggfunc='mean'
            ).reindex(index=ordered_y_display, columns=ordered_x_display, fill_value=0)

        except Exception as e:
            # ... (error handling) ...
            logger.error(f"Error pivoting data for heatmap 'interaction_vs_complexity': {e}")
            fig = go.Figure()
            fig.update_layout(title_text=title, title_x=0.5)
            fig.add_annotation(text=f"Error preparing heatmap data: {e}", showarrow=False, xref="paper", yref="paper", x=0.5, y=0.5)
            return fig
        ...
        for user_inter_display in ordered_y_display:
            ...
            for att_comp_display in ordered_x_display:
                count_val = heatmap_data_count.loc[user_inter_display, att_comp_display]
                avg_cvss_val = heatmap_data_avg_cvss.loc[user_inter_display, att_comp_display]

                text_content = f"Count: {int(count_val)}"
                if count_val > 0 and avg_cvss_val > 0: # Only show avg_cvss if count > 0
        ...
        if max_val == min_val : # If all cells have same value
            threshold = max_val +1 # Ensure all are considered 'lighter' if max_val is low, or 'darker' if max_val is high
        ...
        fig.update_traces(selector=dict(type='heatmap'), texttemplate="", text=[]) # Clear text from heatmap trace
        ...
        for r_idx, y_val in enumerate(ordered_y_display):
            for c_idx, x_val in enumerate(ordered_x_display):
                ...
                cell_texts_for_scatter_flat.append(custom_text_matrix[r_idx][c_idx].replace("<br>", "\n"))
        ...
        fig.add_trace(go.Scatter(
            ...
            textfont=dict(
                size=11,
                color=text_colors_for_scatter # Array of colors
            ),
    ...
    def _plot_cvss_score_by_category_chart(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        if chart_data is None or chart_data.empty or 'display_cve_category' not in chart_data.columns:
            logger.info(f"No data or missing 'display_cve_category' for consolidated CVSS box plot, title '{title}'")
            fig = go.Figure(); fig.update_layout(title_text=title, title_x=0.5, height=300)
            fig.add_annotation(text="No CVSS score data by category to display.", showarrow=False)
            return fig
        ...
        for display_name in chart_data['display_cve_category'].cat.categories:
            ...
            for r_key, d_name in self.category_display_name_map.items():
                if d_name == display_name:
                    raw_cat_key_found = r_key; break
            if not raw_cat_key_found: raw_cat_key_found = display_name.lower().replace(' ', '_')
            color_map_for_display_categories[display_name] = self.category_color_map.get(raw_cat_key_found, '#CCCCCC')
        ...
        base_height_for_titles_margins = 160 # Increased for more top/bottom margin
        plot_height = max(450, (num_display_categories * pixels_per_category_bar) + base_height_for_titles_margins)
        ...
        fig = px.box(
            ...
            category_orders={
                "display_cve_category": chart_data['display_cve_category'].cat.categories.tolist()
            },
            labels={'cvss_score': 'CVSS Base Score', 'display_cve_category': 'Vulnerability Category'},
        ...
        fig.update_layout(
            ...
            yaxis=dict(
                ...
                showline=True, linewidth=1, linecolor='rgb(204,204,204)', # Make Y-axis line visible
                mirror=False # Usually not needed for Y if X has it
            ),
            margin=dict(l=260, r=40, t=80, b=80, pad=5) # Increased left margin, added right padding
        )

        # Adjust box plot visual thickness and other trace properties
        fig.update_traces(
            width=0.65, # Makes horizontal boxes "taller"
            marker=dict(size=5, opacity=0.7), # Style for outlier points if shown
            line=dict(width=1) # Thinner lines for box plot whiskers/median
        )

        return fig

    def _plot_kev_by_category_bar(self, chart_data: pd.DataFrame, title: str) -> go.Figure:
        ...
        fig = px.bar(
            ...
            x='kev_count',
            orientation='h',
            labels={'cve_category': 'Vulnerability Category', 'kev_count': 'Number of Known Exploited CVEs'},
            category_orders={"cve_category": chart_data['cve_category'].tolist()},  # Preserve sort order from data prep
            color='cve_category',
            color_discrete_map=self.category_color_map,
            text_auto=True
        )
        fig.update_layout(showlegend=False, yaxis={'categoryorder': 'total ascending'})  # Keep sorted order
        return fig

    def _plot_top_cwe_in_high_risk_cves_chart(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        ...
        if chart_data is None or chart_data.empty:
            ...
            fig.add_annotation(text="No Top CWE data to display.", showarrow=False)
            return fig
        ...
        fig = px.bar(
            ...
            orientation='h',
            text='count',
            labels={'display_cwe_label': 'CWE', 'count': 'Count in High-Risk CVEs'}
        )
        fig.update_layout(
            title_text=title,
            title_x=0.5,
            ...
            margin=dict(l=300, t=80, b=50, r=30)  # l=300 for potentially long CWE labels
        )
        fig.update_traces(marker_color='#4BAEEA', textposition='outside')
        return fig

    def _plot_top_windows_versions_by_criticality_chart(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        """Generates a stacked horizontal bar chart for top Windows versions by CVE criticality with layout refinements."""
        if chart_data is None or chart_data.empty:
            logger.info(f"No data for _plot_top_windows_versions_by_criticality_chart, title '{title}'")
            return None

        severity_group_order_for_plot = ['Critical', 'High', 'Medium/Low', 'Other/None']

        plot_color_map = {
            'Critical': self.severity_color_map.get('critical', '#E13B30'),  # Fallbacks slightly darker
        ...
        plot_height = max(400, (num_products * pixels_per_bar) + base_plot_height)
        ...
        fig = px.bar(
            ...
            orientation='h',
            labels={
                'windows_edition_version_arch': 'Windows Edition / Version / Architecture',
                'count': 'Number of Unique CVEs',
                'severity_group': 'Severity Group'
            },
            category_orders={
                "severity_group": severity_group_order_for_plot,
                "windows_edition_version_arch": chart_data['windows_edition_version_arch'].cat.categories.tolist()
            },
        ...
        fig.update_layout(
            ...
            legend=dict(
                orientation="h",
                yanchor="bottom", y=-0.3,  # Position below plot; adjust y and margin.b
                xanchor="center", x=0.5,
                bordercolor="LightGrey",
                borderwidth=1,
                bgcolor="rgba(255,255,255,0.85)",  # Slightly more opaque background
                title=dict(
                    text="<b>Severity Group</b>",
                    font=dict(size=11)
                ),
                font=dict(size=10)
            ),
    ...
    def _plot_days_to_nvd_by_severity_boxplots(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        """Generates vertical box plots of 'Days to NVD Publication' by severity."""
        if chart_data is None or chart_data.empty:
            logger.info(f"No data for _plot_days_to_nvd_by_severity_boxplots, title '{title}'")
            return None
        ...
        fig = px.box(
            ...
            category_orders={
                "display_severity_type": [self.severity_display_name_map.get(k, k) for k in self.severity_order]
            },
            labels={
                'days_to_nvd': 'Days to NVD Publication (from Vendor Patch)',  # Y-axis title
    ...
    def _plot_spotlight_cves_cvss_scores_dot_plot(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        """Generates a horizontal dot plot of CVSS scores for spotlighted CVEs with layout refinements."""
        if chart_data is None or chart_data.empty:
            logger.info(f"No data for _plot_spotlight_cves_cvss_scores_dot_plot, title '{title}'")
            return None

        # Sort for y-axis order (highest score at the top)
        plot_data_sorted = chart_data.sort_values(by='cvss_score', ascending=True).copy()

        # --- Prepare Y-axis labels with bolding ---
        plot_data_sorted['cve_id_bold'] = '<b>' + plot_data_sorted['cve_id'].astype(str) + '</b>'

        # --- Prepare text labels for scores with bolding ---
        plot_data_sorted['cvss_score_text_bold'] = plot_data_sorted['cvss_score'].apply(lambda x: f"<b>{x:.1f}</b>")
        ...
        for index, row in plot_data_sorted.iterrows():
            fig.add_shape(type='line',
                          x0=0, y0=row['cve_id_bold'],  # Use bolded CVE ID for y0/y1
                          x1=row['cvss_score'], y1=row['cve_id_bold'],
                          line=dict(color=self.spotlight_plot_color, width=1, dash='dash'))  # Thinner, dashed line

        # Scatter trace for markers and text
        fig.add_trace(go.Scatter(
            x=plot_data_sorted['cvss_score'],
            y=plot_data_sorted['cve_id_bold'],  # Use bolded CVE ID for y-axis categories
            mode='markers+text',
            marker=dict(color=self.spotlight_plot_color, size=9),  # Slightly smaller marker
            text=plot_data_sorted['cvss_score_text_bold'],  # Use bolded score text
            textposition="middle right",
            textfont=dict(size=10, color=self.spotlight_plot_color),  # Text color same as marker
            hoverinfo='text',
            customdata=plot_data_sorted[['title', 'cve_id', 'cvss_score']].values,
            hovertemplate=(
        ...
        pixels_per_cve_row = 35  # Adjust for desired spacing between y-axis labels
        base_height_for_titles_margins = 120  # Space for title, x-axis, margins
        plot_height = max(350, (num_cves * pixels_per_cve_row) + base_height_for_titles_margins)
        ...
        fig.update_layout(
            ...
            xaxis=dict(
                range=[-0.5, 10.5],  # Start slightly before 0 for lollipop line origin
            ...
            yaxis=dict(
                categoryorder='array',
                categoryarray=plot_data_sorted['cve_id_bold'].tolist(),  # Use bolded list for order
            ...
            margin=dict(l=200, r=60, t=80, b=80, pad=5),  # Significantly increased left margin, increased right for text
    ...
    def _plot_cat_av_pr_chart(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        if chart_data is None or chart_data.empty:
            logger.info(f"No data for _plot_cat_av_pr_chart title '{title}'")
            fig = go.Figure(); fig.update_layout(title_text=title, title_x=0.5, height=300)
            fig.add_annotation(text="No data available for this chart.", showarrow=False)
            return fig
        ...
        if num_rows <= 1: facet_row_spacing_val = 0.05

        # --- Horizontal Facet Spacing ---
        facet_col_spacing_val = 0.05 # Adjust this value (0 to 1) for space between facet columns
        ...
        fig = px.bar(
            ...
            labels={'display_attack_vector': 'Attack Vector', 'count': 'CVE Count', 'display_privileges_required': 'Privileges', 'display_cve_category': 'Vulnerability Category'},
            category_orders={
                "display_attack_vector": [self.attack_vector_display_map.get(k, k) for k in self.attack_vector_order],
                "display_privileges_required": [self.privileges_required_display_map.get(k, k) for k in self.privileges_required_order],
                "display_cve_category": [self.category_display_name_map.get(k, k) for k in self.category_order]
            },
            color_discrete_map=color_map_for_display_privs,
            barmode='group',
            text_auto=True,
        ...
        fig.update_layout(
            ...
            legend=dict(
                ...
                title=dict(
                    ...
                    font=dict(size=11) # Slightly larger/different font for title if desired
                )
            ),
            margin=dict(l=130, r=40, t=100, b=200) # Keep increased bottom margin
                                                   # give more room on the left edge 'l=120'
        )

        fig.for_each_annotation(lambda a: a.update(text=f"<b>{a.text.split('=')[-1]}</b>", font=dict(size=11)))
        ...
        if pd.isna(max_y_val_overall) or max_y_val_overall <= 0:
            ...
            padding_points = 3
            y_upper_limit = np.ceil(max_y_val_overall + padding_points) # Using ceil for integer upper limit

            # Ensure a minimum range if max_y_val_overall is very small, e.g. 1 or 2
            if y_upper_limit < 5: # if max bar is 1, padding makes it 4, still small.
                y_upper_limit = max(5, np.ceil(max_y_val_overall + 1)) # Ensure at least a bit of space or min height of 5

        common_yrange = [0, y_upper_limit]

        # Loop to set Y-axis title "CVE Count" ONLY on the first facet of each row.
        for i in range(1, num_categories + 1): # num_categories from your function
            is_first_col_facet = (i - 1) % facet_col_wrap == 0 # facet_col_wrap from your function
            yaxis_name = f"yaxis{i if i > 1 else ''}"
            xaxis_name = f"xaxis{i if i > 1 else ''}" # For bottom row x-tick logic
            ...
            if xaxis_name in fig.layout:
                ...
                if current_row_idx == (num_rows - 1): # num_rows from your function
    ...
    def _plot_cat_ui_ac_chart(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        logger.info(f"Plotting _plot_cat_ui_ac_chart, type: {type(chart_data)}. Chart data: {chart_data.head()}")
        if chart_data is None or chart_data.empty:
            # ... (no data handling) ...
        ...
        fig = px.bar(
            ...
            labels={'display_user_interaction': 'User Interaction', 'count': 'CVE Count', 'display_attack_complexity': 'Complexity', 'display_cve_category': 'Vulnerability Category'},
            category_orders={  # ... (category_orders definition) ...
                "display_user_interaction": [self.user_interaction_display_map.get(k, k) for k in self.user_interaction_order],
                "display_attack_complexity": [self.attack_complexity_display_map.get(k, k) for k in self.attack_complexity_order],
                "display_cve_category": [self.category_display_name_map.get(k, k) for k in self.category_order]
            },
            color_discrete_map=color_map_for_display_ac,
            barmode='group', text_auto=True, height=plot_height
        )
        ...
        for i in range(1, num_categories + 1):
            ...
            current_row_idx = (i - 1) // facet_col_wrap  # For x-axis bottom row check

            yaxis_name = f"yaxis{i if i > 1 else ''}"
            xaxis_name = f"xaxis{i if i > 1 else ''}"  # For x-axis bottom row check
            ...
            if yaxis_name in fig.layout:
                if is_first_col_facet:
                    ...
                    fig.layout[yaxis_name].title.text = ""
                fig.layout[yaxis_name].range = common_yrange  # Enforce common y-axis range

            # Ensure x-axis tick labels are shown on bottom row facets
            if xaxis_name in fig.layout:
                if current_row_idx == (num_rows - 1):  # num_rows calculated earlier
                    fig.layout[xaxis_name].showticklabels = True
    ...
    def _plot_top_cwe_av_cvss_chart(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        if chart_data is None or chart_data.empty or 'display_primary_cwe_id' not in chart_data.columns:
            logger.info(f"No data or missing columns for _plot_top_cwe_av_cvss_chart, title '{title}'")
            fig = go.Figure(); fig.update_layout(title_text=title, title_x=0.5, height=300)
            fig.add_annotation(text="No Top CWE data by Attack Vector to display.", showarrow=False)
            return fig
        ...
        num_rows = (num_facets + facet_col_wrap - 1) // facet_col_wrap if num_facets > 0 else 1

        # --- Standardized Height and Spacing ---
        row_height_alloc = 200
        base_plot_height_for_titles_etc = 150
        plot_height = max(400, (row_height_alloc * num_rows) + base_plot_height_for_titles_etc)

        facet_row_spacing_val = 0.12 # Standardized vertical spacing between facet rows
        if num_rows <= 1: facet_row_spacing_val = 0.1
        facet_col_spacing_val = 0.06 # Standardized horizontal facet spacing
        # --- End Spacing ---

        fig = px.box(
            chart_data, x='cvss_score', y='display_attack_vector', color='display_attack_vector',
            color_discrete_map=color_map_for_display_av,
            facet_col='display_primary_cwe_id', facet_col_wrap=facet_col_wrap,
            facet_row_spacing=facet_row_spacing_val, facet_col_spacing=facet_col_spacing_val,
            orientation='h',
            labels={ 'cvss_score': 'CVSS Base Score', 'display_attack_vector': 'Attack Vector', 'display_primary_cwe_id': 'CWE' },
            category_orders={
                "display_attack_vector": [self.attack_vector_display_map.get(k, k) for k in self.attack_vector_order],
                "display_primary_cwe_id": chart_data['display_primary_cwe_id'].cat.categories.tolist()
            },
            points="outliers", height=plot_height,
        )
        ...
        fig.update_layout(
            ...
            legend=dict(
                orientation="v",
                yanchor="top", y=0.3,  # Position legend below plot area
                xanchor="center", x=0.85,
        ...
        fig.for_each_annotation(lambda a: a.update(text=f"<b>{a.text.split('=')[-1]}</b>", font=dict(size=10)))
        ...
        for i in range(1, num_facets + 1):
            ...
            if y_axis_name in fig.layout:
                ...
                if is_first_col_facet:
                    ...
                    fig.layout[y_axis_name].title.standoff = 14 # Ample standoff for Y-title
            ...
            if x_axis_name in fig.layout:
                ...
                if current_row_idx == (num_rows - 1):
                    ...
                    fig.layout[x_axis_name].title.text = "<b>CVSS Base Score</b>" # Ensure title on bottom row facets
                elif not fig.layout[x_axis_name].matches : # If x-axes somehow became un-matched
                    fig.layout[x_axis_name].showticklabels = False # Hide on inner rows
                    fig.layout[x_axis_name].title.text = ""

        return fig

    def _plot_tsne_cve_profile_chart(self, chart_data: pd.DataFrame, title: str) -> go.Figure | None:
        if chart_data is None or chart_data.empty or 'cluster_label' not in chart_data.columns:
            logger.info(f"No data or missing 'cluster_label' for _plot_tsne_cve_profile_chart, title '{title}'")
            fig = go.Figure()
            fig.update_layout(title_text=title, title_x=0.5, height=300)
            fig.add_annotation(text="Not enough data or clusters to display t-SNE plot.", showarrow=False)
            return fig
        ...
        def sort_key_cluster_labels(label): # Helper for sorting legend
            if "(Auto)" in label: return (2, label)
            if "Profile Group" in label and "(Empty)" not in label : return (1, label)
            return (0, label)
        unique_cluster_labels = sorted(chart_data['cluster_label'].unique(), key=sort_key_cluster_labels)
        ...
        mapped_cve_cat_hover = chart_data_hover['cve_category'].map(self.category_display_name_map)
        chart_data_hover['cve_category_display'] = mapped_cve_cat_hover.fillna(chart_data_hover['cve_category'].astype(object))

        mapped_av_hover = chart_data_hover['attack_vector'].map(self.attack_vector_display_map)
        chart_data_hover['attack_vector_display'] = mapped_av_hover.fillna(chart_data_hover['attack_vector'].astype(object))

        mapped_ac_hover = chart_data_hover['attack_complexity'].map(self.attack_complexity_display_map)
        chart_data_hover['attack_complexity_display'] = mapped_ac_hover.fillna(chart_data_hover['attack_complexity'].astype(object))

        mapped_pr_hover = chart_data_hover['privileges_required'].map(self.privileges_required_display_map)
        chart_data_hover['privileges_required_display'] = mapped_pr_hover.fillna(chart_data_hover['privileges_required'].astype(object))

        mapped_ui_hover = chart_data_hover['user_interaction'].map(self.user_interaction_display_map)
        chart_data_hover['user_interaction_display'] = mapped_ui_hover.fillna(chart_data_hover['user_interaction'].astype(object))
        ...
        fig = px.scatter(
            ...
            opacity=0.75,
            custom_data=[
                'cve_id', 'cvss_score', 'cluster_label',  # cluster_label is for hover, not just color
                'cve_category_display', 'attack_vector_display', 'attack_complexity_display',
                'privileges_required_display', 'user_interaction_display'
            ],
            color_discrete_map=dynamic_cluster_color_map,
            labels={'cluster_label': 'Identified CVE Profile'},  # For legend title
            size_max=18
        )
        ...
        fig.update_layout(
            ...
            legend=dict(
                ...
                yanchor="top",  y=1,  # Align top of legend with top of plot area
                xanchor="left", x=1.01,# Position legend just to the right of plot area
            ...
            margin=dict(l=60, r=200, t=80, b=60, pad=5),  # Adjusted top margin for legend
            height=550
        )

        return fig

    def _generate_plotly_figure(self, chart_data: Any, chart_key: str, chart_title_override: Optional[str] = None) -> Optional[go.Figure]:
        ...
        if chart_data is None or (isinstance(chart_data, pd.DataFrame) and chart_data.empty):
            logger.warning(f"No data provided or empty DataFrame for chart '{chart_key}'. Cannot generate figure.")
            return None

        # Determine the chart title
        final_chart_title = chart_title_override  # 1. Prioritize override passed directly

        if final_chart_title is None:  # 2. If no override, try REPORT_STRUCTURE
        ...
        if fig_handler_method:
            try:
                logger.info(f"Using figure handler: {fig_handler_method.__name__} for chart '{chart_key}'")
                ...
                logger.exception(f"Error executing figure handler '{fig_handler_method.__name__}' for chart '{chart_key}': {e}")
                return None  # Return None if specific handler fails
        else:
            logger.warning(f"No Plotly figure generation handler defined for chart key '{chart_key}'.")
            return None
        ...
        if fig:
            try:
                ...
                if 'report_light' in pio.templates:  # Check if your custom template is registered
                    active_theme_name = 'report_light'
                else:
                    logger.debug("Custom Plotly template 'report_light' not found, using 'plotly_white'.")
                ...
                if fig.layout.legend is None or (fig.layout.legend and fig.layout.legend.orientation is None and fig.layout.legend.x is None):
                    common_layout_updates['legend_title_text'] = '' # Default no legend title
                    common_layout_updates['legend'] = dict(
                        orientation="h", yanchor="bottom", y=1.02, xanchor="right", x=1
                    )
                elif fig.layout.legend and fig.layout.legend.title.text is None: # If legend exists but no title
                    common_layout_updates['legend_title_text'] = ''

                fig.update_layout(**common_layout_updates)

            except Exception as e:
                logger.exception(f"Error applying common layout updates for chart '{chart_key}': {e}")
                # Decide if you want to return the fig without common layout or None
                # return None
        else:  # fig is None from handler
            logger.warning(f"Figure object is None after handler for '{chart_key}', cannot apply common layout.")
        logger.info(f"Generated figure for chart '{chart_key}' with [{fig_handler_method.__name__}]")
        return fig
    ...
    async def _get_llm_response(
        ...
        **kwargs
        ...
        text_response = f"Error: LLM response generation failed for {prompt_template_name}."  # Default error response
        usage_info_from_api: Optional[Dict[str, int]] = None  # To store what API returns

        logger.info(f"Generating LLM insight using template: {prompt_template_name} with model: {llm_model}")
        if not self.llm:
            logger.warning("LLM client not configured/injected. Returning placeholder.")
            # Log a dummy usage entry for attempts
            text_response, usage_info_from_api = f"Placeholder: {prompt_template_name} - LLM client missing.", None
        ...
        try:
            ...
            input_tokens_rendered = self._count_tokens(text=rendered_prompt, model_name=llm_model)
            input_tokens_system = self._count_tokens(text=system_prompt, model_name=llm_model)
            kwargs_for_llm = {**kwargs, 'task_type': task_type}

            text_response, usage_info_from_api = await self.llm.aget_completion(
                model=llm_model,
            ...
            total_input_tokens_final = input_tokens_rendered + input_tokens_system  # Our calculation
            status = "Success"

            if usage_info_from_api:  # If API provided usage
                completion_tokens_final = usage_info_from_api.get("completion_tokens", 0)
                # Prioritize API's prompt_tokens if available and makes sense
                if usage_info_from_api.get("prompt_tokens", 0) > 0:
                    total_input_tokens_final = usage_info_from_api.get("prompt_tokens", total_input_tokens_final)
            elif text_response and not text_response.startswith("Error:") and not text_response.startswith("Placeholder:") and not text_response.startswith("LiteLLM API Error:"):
                # Fallback: estimate completion tokens if API didn't provide and response seems successful
                completion_tokens_final = self._count_tokens(text=text_response, model_name=llm_model)
            else:  # Error or placeholder, no meaningful completion tokens
                status = f"Failed - Response: {text_response[:50]}..." if not text_response.startswith("Placeholder:") else "Skipped - Placeholder"

            pricing_config = self.TOKEN_PRICING.get(llm_model, self.TOKEN_PRICING["default_llm_pricing"])
            cost = ((total_input_tokens_final / 1000) * pricing_config["input_1k"] +
                    (completion_tokens_final / 1000) * pricing_config["output_1k"])

            usage_entry = {
                "timestamp": request_timestamp, "prompt_template_name": prompt_template_name,
                "task_type": task_type, "model_name": llm_model, "status": status,
                "system_prompt_tokens": input_tokens_system,
                "rendered_prompt_tokens": input_tokens_rendered,
                "total_input_tokens_calculated": input_tokens_system + input_tokens_rendered,
                "total_input_tokens_api_reported": usage_info_from_api.get("prompt_tokens") if usage_info_from_api else None,
                "completion_tokens_api_reported": usage_info_from_api.get("completion_tokens") if usage_info_from_api else None,
            ...
            if status == "Success":
                logger.info(f"LLM call for '{prompt_template_name}' successful. Input: {total_input_tokens_final}, Output: {completion_tokens_final}, Cost: ${cost:.6f}")
            else:
                logger.warning(f"LLM call for '{prompt_template_name}' resulted in status: {status}. Input(calc): {usage_entry['total_input_tokens_calculated']}, Output(est): {completion_tokens_final}, Cost: ${cost:.6f}")

            return text_response  # Return only the text response

        except Exception as e:  # Catch errors from template rendering, token counting, or unexpected issues
            logger.exception(f"Outer error in _get_llm_response for template {prompt_template_name}: {e}")
            # Log failed usage
            cost_on_error = ((input_tokens_rendered + input_tokens_system) / 1000) * self.TOKEN_PRICING.get(llm_model, self.TOKEN_PRICING["default_llm_pricing"])["input_1k"] if (input_tokens_rendered + input_tokens_system) > 0 else 0.0
            usage_entry = {
                "timestamp": request_timestamp, "prompt_template_name": prompt_template_name,
                "task_type": task_type, "model_name": llm_model, "status": f"Error - {type(e).__name__}",
                "system_prompt_tokens": input_tokens_system, "rendered_prompt_tokens": input_tokens_rendered,
                "total_input_tokens_calculated": input_tokens_system + input_tokens_rendered,
                "total_input_tokens_api_reported": None, "completion_tokens_api_reported": None,
                "final_input_tokens_for_cost": input_tokens_system + input_tokens_rendered,
                "final_completion_tokens_for_cost": 0,
                "cost_estimate": round(cost_on_error, 6)
            }
            self.llm_token_usage_log.append(usage_entry)
            return f"Error preparing/generating insight for {prompt_template_name}. Details: {str(e)}"
    ...
    def _generate_appendix_tables(
        ...
        severity_color_map = {
            'critical': 'text-brand-red-700 dark:text-brand-red-500 font-semibold',
            'high': 'text-brand-orange-600 dark:text-brand-orange-400 font-semibold',
            'medium': 'text-brand-blue-600 dark:text-brand-blue-400 font-semibold',
            'low': 'text-brand-green-600 dark:text-brand-green-400 font-semibold',
        ...
        if df.empty and not calculated_metrics:
            logger.warning("Main DataFrame and calculated metrics are empty, cannot generate appendix tables.")
            ...
            for table_def in table_defs:
                ...
                appendix_tables_html[table_id] = {
                    'title': table_title,
                    'html': (
                        f"<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>No data available to generate this table.</p>"
                    )
                }
        ...
        for table_def in table_defs:
            ...
            if df_source_metric and calculated_metrics:
                ...
                elif isinstance(metric_data, dict) and 'dataframe' in metric_data and isinstance(metric_data['dataframe'], pd.DataFrame):
                    current_df_for_processing = metric_data['dataframe'].copy()
                else:
                    logger.warning(f"DataFrame source metric '{df_source_metric}' for table '{table_id}' not found or not a DataFrame.")
            ...
            if current_df_for_processing is None:
                if not df.empty:
                    ...
                    logger.warning(f"No valid DataFrame source found for table '{table_id}' and main df is empty.")
                    appendix_tables_html[table_id] = {
                        'title': table_title,
                        'html': (
                            f"<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>No data available for table '{table_id}'.</p>"
                        )
                    }
            ...
            # ========================================================================
            if table_id not in ["appendix_outlier_list", "appendix_all_metrics"]:
                if current_df_for_processing is None or current_df_for_processing.empty:
                    table_html_content = (
                        f"<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>No data available for table '{table_id}'.</p>"
                    )
                else:
                    cols_in_df = [col for col in cols_to_display_map.keys() if col in current_df_for_processing.columns]
                    if not cols_in_df:
                        table_html_content = (
                            f"<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>"
                            f"Error: No relevant columns found for table '{table_id}'.</p>"
                        )
                    else:
                        # --- Data Preparation (as you've implemented) ---
                        df_to_render = current_df_for_processing[cols_in_df].copy()

                        if "cve_category" in df_to_render.columns:
                            df_to_render["cve_category"] = df_to_render["cve_category"].map(
                                lambda x: cve_category_map.get(str(x).lower(), str(x))
                            ).fillna("Unknown")

                        if "severity_type" in df_to_render.columns:
                            df_to_render["severity_type_normalized"] = df_to_render["severity_type"].astype(str).str.lower().fillna('unknown')
                        ...
                        if 'published' in df_to_render.columns:
                            df_to_render['published'] = pd.to_datetime(df_to_render['published'], errors='coerce')
                        if 'cvss_score' in df_to_render.columns:
                            df_to_render['cvss_score'] = pd.to_numeric(df_to_render['cvss_score'], errors='coerce')
                        ...
                        if sort_by_columns:
                            df_to_render = df_to_render.sort_values(by=sort_by_columns, ascending=ascending_order)

                        if 'published' in df_to_render.columns:
                            df_to_render['published'] = df_to_render['published'].dt.strftime('%Y-%m-%d')
                        if 'cvss_score' in df_to_render.columns:
                            df_to_render['cvss_score'] = df_to_render['cvss_score'].apply(lambda x: f"{x:.1f}" if pd.notna(x) else x)
                        # --- End Data Preparation ---

                        # --- HTML Generation for Standard Tables ---
                        html_parts_list = ["<div class='overflow-x-auto report-table-wrapper'>"]
                        html_parts_list.append("<table class='min-w-full table-fixed divide-y divide-gray-200 dark:divide-gray-700'>")
                        html_parts_list.append("<thead class='bg-gray-50 dark:bg-gray-800'><tr>")
                        th_base_classes = "px-2 py-1.5 text-left text-sm font-semibold text-gray-500 dark:text-gray-300 title-case tracking-wider"
                        additional_th_classes = ""
                        for col_key in cols_in_df:
                            display_name = cols_to_display_map[col_key]
                            css_col_key = col_key.lower().replace('_type', '').replace('_', '-')
                            if col_key == 'cvss_score':
                                ...
                                additional_th_classes = ""
                            html_parts_list.append(f"<th class='col-{css_col_key} {th_base_classes} {additional_th_classes}'>{display_name}</th>")
                        html_parts_list.append("</tr></thead>")
                        html_parts_list.append("<tbody class='bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700'>")
                        for _, row_data in df_to_render.iterrows():
                            html_parts_list.append("<tr class='hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-150 ease-in-out'>")
                            for col_key in cols_in_df:
                                cell_value = row_data.get(col_key)
                                display_value = str(cell_value) if pd.notna(cell_value) else "N/A"

                                td_class_list = [f"col-{col_key.lower().replace('_type', '').replace('_', '-')}", "px-2 py-1.5", "text-xs"]
                                if col_key == 'cve_id':
                                    td_class_list.append("text-brand-pink-600 dark:text-brand-pink-400 font-semibold whitespace-nowrap")
                                    if row_click_config.get('enabled') and col_key == row_click_config.get('id_column'):
                                        url_template = row_click_config.get('url_template')
                                        id_val_for_url = row_data.get(row_click_config['id_column'])
                                        if url_template and pd.notna(id_val_for_url):
                                            link_url = url_template.replace(f"{{{row_click_config['id_column']}}}", str(id_val_for_url))
                                            display_value = f"<a href='{link_url}' target='_blank' rel='noopener noreferrer' class='text-brand-pink-600 dark:text-brand-pink-400 font-medium'>{display_value}</a>"
                                elif col_key == "severity_type":  # Key in cols_to_display_map
                                    # Use 'severity_type_normalized' which exists on row_data if severity_type was processed
                                    severity_val_for_color = row_data.get("severity_type_normalized", "unknown")
                                    color_class = severity_color_map.get(severity_val_for_color, severity_color_map['unknown'])
                                    td_class_list.append(color_class)
                                    # Display original severity value if it exists, otherwise the processed one
                                    original_severity_display = row_data.get("severity_type") # Column is set to categorical above
                                    display_value = str(original_severity_display) if pd.notna(original_severity_display) else "N/A"
                                elif col_key == "title":
                                    td_class_list.extend(["truncate", "max-w-sm"])
                                else:
                                    td_class_list.append("text-gray-700 dark:text-gray-300")

                                html_parts_list.append(f"<td class='{' '.join(td_class_list)}'>{display_value}</td>")
            ...
            # ========================================================================
                ...
                if df.empty:
                    table_html_content = "<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>Main CVE data is empty, cannot calculate outliers.</p>"
                    # Append to all_tables_html and continue to next table_def
                    appendix_tables_html[table_id] = {
                        'title': table_def.get('title', table_id.replace("_", " ").title()),
                        'html': table_html_content
                    }
                    continue

                iqr_metrics_by_cat = calculated_metrics.get('cvss_iqr_by_category', {})
                if not iqr_metrics_by_cat:
                    table_html_content = "<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>CVSS IQR metrics by category not available.</p>"
                    appendix_tables_html[table_id] = {
                        'title': table_def.get('title', table_id.replace("_", " ").title()),
                        'html': table_html_content
                    }
                ...
                if 'cvss_score' not in df.columns or 'cve_category' not in df.columns:
                    table_html_content = "<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>Required columns ('cvss_score', 'cve_category') not in source data.</p>"
                    appendix_tables_html[table_id] = {
                        'title': table_def.get('title', table_id.replace("_", " ").title()),
                        'html': table_html_content
                    }
                ...
                temp_df['cvss_score'] = pd.to_numeric(temp_df['cvss_score'], errors='coerce')
                ...
                if "cve_category" in temp_df.columns and 'cve_category_map' in locals():
                    temp_df["cve_category_mapped"] = temp_df["cve_category"].astype(str).str.lower().map(
                        lambda x: cve_category_map.get(x, x)  # Use mapped value or original if not in map
                    ).fillna("Unknown")
                else:
                    # If no map or column, use original or a placeholder
                    temp_df["cve_category_mapped"] = temp_df["cve_category"].astype(str).fillna("Unknown")
                ...
                for category_key, metrics in iqr_metrics_by_cat.items():
                    ...
                    if effective_lower_fence is None and effective_upper_fence is None:
                        continue

                    category_cves = temp_df[temp_df['cve_category'] == category_key]

                    for index, row in category_cves.iterrows():
                        cvss = row['cvss_score']
                        row_dict = row.to_dict()  # Convert row to dict to append new key
                ...
                if not outlier_rows:
                    table_html_content = "<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>No CVSS score outliers found based on IQR criteria.</p>"
                else:
                    final_outlier_df = pd.DataFrame(outlier_rows)
                    cols_to_display_map_outliers = table_def.get('columns', { # Default to empty if not defined in report_structure.yml
                        'cve_id': 'CVE ID', 'title': 'Title', 'outlier_type': 'Outlier Type',
                        'cvss_score': 'CVSS Score', 'cve_category': 'CVE Category', 'published': 'Published'
                    })
                    cols_to_use_outliers = [col for col in cols_to_display_map_outliers.keys() if col in final_outlier_df.columns]

                    if not cols_to_use_outliers:
                        table_html_content = "<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>No relevant columns for CVSS outliers table.</p>"
                    else:
                        df_to_render = final_outlier_df[cols_to_use_outliers].copy()
                        ...
                        if "severity_type" in df_to_render.columns:
                            df_to_render["severity_type_normalized"] = df_to_render["severity_type"].astype(str).str.lower().fillna('unknown')
                            df_to_render["severity_type"] = pd.Categorical(
                                df_to_render["severity_type_normalized"], categories=severity_order, ordered=True
                            )
                        ...
                        if sort_by_columns_ot:
                            df_to_render = df_to_render.sort_values(by=sort_by_columns_ot, ascending=ascending_order_ot)
                        ...
                        for col_key in cols_to_use_outliers:
                            display_name = cols_to_display_map_outliers[col_key]
                            css_col_key = col_key.lower().replace('_type', '').replace('_', '-')
                            th_base_classes = "px-2 py-1.5 text-left text-sm font-semibold text-gray-500 dark:text-gray-300 title-case tracking-wider"
                            additional_th_classes = ""
                            if col_key == 'cvss_score':
                        ...
                        for _, row_data in df_to_render.iterrows():
                            ...
                            for col_key in cols_to_use_outliers:
                                ...
                                if col_key.lower() == "title":
                                    td_class_list.extend(["text-report-text", "dark:text-report-text-dark", "truncate", "max-w-sm"])
                                    specific_color_applied = True
                                elif col_key == "severity_type" and "severity_type_normalized" in row_data:
                                    severity_val_for_color = row_data.get("severity_type_normalized", "unknown")
                                    color_class = severity_color_map.get(severity_val_for_color, severity_color_map['unknown'])
                                    td_class_list.append(color_class) # This appends "text-brand-red-700 dark:text-brand-red-500" etc.

                                    # Also append font-semibold for severity text as seen in the screenshot
                                    td_class_list.append("font-semibold")

                                    original_severity_display = row_data.get("severity_type")
                                    display_value = str(original_severity_display) if pd.notna(original_severity_display) else "N/A"
                                    specific_color_applied = True

                                elif col_key == 'outlier_type':
                                    outlier_status = row_data.get('outlier_type', '')
                                    if outlier_status == "Low Outlier":
                                        td_class_list.append("text-green-700 dark:text-green-400 bg-green-50 dark:bg-green-800/30 font-medium px-2 py-0.5 rounded-md")
                                        specific_color_applied = True
                                    elif outlier_status == "High Outlier":
                                        # Styling for 'bad' outliers (e.g., CVSS score above upper fence)
                                        td_class_list.append("text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-800/30 font-medium px-2 py-0.5 rounded-md")
                                        specific_color_applied = True
                                    # The display_value itself (e.g., "Low Outlier") is already set correctly
                                elif col_key == "cvss_score":
                                    td_class_list.append("w-8")

                                if row_click_config.get('enabled', True) and col_key == row_click_config.get('id_column', 'cve_id'):
                                    td_class_list.append("whitespace-nowrap")
                                    url_template = row_click_config.get('url_template', "https://www.cve.org/CVERecord?id={cve_id}")  # Fallback URL template
                                    id_val_for_url = row_data.get(col_key)  # use col_key directly
                                    if pd.notna(id_val_for_url):
                                        link_url = url_template.replace(f"{{{col_key}}}", str(id_val_for_url))  # use col_key
                                        display_value = f"<a href='{link_url}' target='_blank' rel='noopener noreferrer' class='text-brand-pink-600 dark:text-brand-pink-400 font-medium'>{display_value}</a>"
                                if not specific_color_applied:
                                    td_class_list.extend(["text-gray-700", "dark:text-gray-300"])
            ...
            # ========================================================================
                ...
                def _process_metric_display_value(
                    ...
                    if original_metric_key_for_context == "top_3_affected_builds" and isinstance(value, list):
                        ...
                        for index, item_dict in enumerate(value):
                            if isinstance(item_dict, dict):
                                ...
                                count = html.escape(str(item_dict.get("count", "N/A")))

                                # "Build #{index + 1}" label
                                html_parts.append(
                                    f'<div class="font-semibold text-sm mt-3 mb-1">Build #{index + 1}</div>'
                                )

                                # Inner UL for build and count details
                                inner_list_items = [
                                    f'<li class="text-xs"><strong class="font-medium">Build Version:</strong> {build_version}</li>',
                                    f'<li class="text-xs"><strong class="font-medium">Count:</strong> {count}</li>'
                                ]
                                inner_list_html = "".join(inner_list_items)

                                html_parts.append(
                                    f'<ul class="list-disc list-inside pl-5 text-xs mb-2">{inner_list_html}</ul>'
                                )
                            else:
                                # Fallback for unexpected item type in the list
                                html_parts.append(
                                    f'<div class="font-semibold text-sm mt-3 mb-1">Item #{index + 1}</div>'
                                )
                                html_parts.append(
                                    f'<ul class="list-disc list-inside pl-5 text-xs mb-2"><li>{html.escape(str(item_dict))}</li></ul>'
                                )
                    ...
                    if isinstance(value, dict):
                        ...
                        if original_metric_key_for_context == "cve_category_distribution" and is_sub_item:
                            return {
                        ...
                        elif original_metric_key_for_context == "cvss_iqr_by_category" and is_sub_item:
                            return {
                                k: _process_metric_display_value(
                                    v, original_metric_key_for_context, True
                                )
                                for k, v in value.items()
                                if k not in ["id_for_color"] # Exclude id_for_color here
                            }
                ...
                def _format_complex_value_to_html(value, level=0) -> str:
                    if isinstance(value, dict):
                        ...
                        for k, v_item in value.items():
                            formatted_v = _format_complex_value_to_html(v_item, level + 1)
                            items_html += f"<li><strong class='font-semibold'>{k}:</strong> {formatted_v}</li>"
                        return f"<ul class='list-none pl-4 text-left'>{items_html}</ul>" if level == 0 else f"<ul class='list-none pl-4'>{items_html}</ul>"
                    elif isinstance(value, list):
                        if not value: return "[ ]"
                        items_html = "".join([f"<li>{_format_complex_value_to_html(item, level + 1)}</li>" for item in value])
                        return f"<ul class='list-disc list-inside pl-4 text-left'>{items_html}</ul>" if level == 0 else f"<ul class='list-disc list-inside pl-4'>{items_html}</ul>"
                    else:
                        return str(value)

                if not calculated_metrics:
                    table_html_content = "<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>No calculated metrics provided to display.</p>"
                else:
                    for metric_key, metric_value_original in calculated_metrics.items():
                        if "delta" in metric_key.lower() or \
                           "qoq_trend_direction" in metric_key.lower() or \
                           metric_key.endswith("_description") or \
                           metric_key.endswith("_context"):
                            continue
                        ...
                        processed_value_structure = _process_metric_display_value(metric_value_original, metric_key)

                        if metric_key == "cve_category_distribution" and isinstance(metric_value_original, list):
                            if not metric_value_original:
                                ...
                                for index, original_item_dict in enumerate(metric_value_original):
                                    row_counter += 1
                                    item_name_for_label = original_item_dict.get("name", f"Item {index + 1}")
                                    processed_item_value = "Error processing item"
                                    if isinstance(processed_value_structure, list) and index < len(processed_value_structure):
                                        processed_item_value = processed_value_structure[index]
                                    all_metrics_records.append({
                                        'row_number': row_counter,
                                        'metric_name': f"{main_metric_label}: {item_name_for_label}",
                                        'metric_value': processed_item_value
                                    })
                        elif metric_key == "cvss_iqr_by_category" and isinstance(processed_value_structure, dict):
                            if not processed_value_structure:
                                ...
                                for sub_cat_key, sub_cat_value_processed in processed_value_structure.items():
                                    row_counter += 1
                                    sub_cat_display_name = sub_cat_key.replace("_", " ").title()
                                    all_metrics_records.append({
                                        'row_number': row_counter,
                                        'metric_name': f"{main_metric_label}: {sub_cat_display_name}",
                                        'metric_value': sub_cat_value_processed
                                    })
                        else:
                            row_counter += 1
                            all_metrics_records.append({
                    ...
                    if not all_metrics_records:
                        table_html_content = "<p class='text-sm text-gray-600 dark:text-gray-400 mt-2'>No metrics to display after filtering.</p>"
                    else:
                        ...
                        html_parts_list = ["<div class='overflow-x-auto report-table-wrapper'>"]
                        html_parts_list.append("<table class='min-w-full divide-y divide-gray-200 dark:divide-gray-700'>")
                        html_parts_list.append("<thead class='bg-gray-50 dark:bg-gray-800'><tr>")
                        for col_key_map in cols_to_display_map_metrics.keys():
                            display_name = cols_to_display_map_metrics[col_key_map]
                            ...
                            html_parts_list.append(
                                f"<th class='col-{css_col_key} {width_class} px-2 py-1.5 text-left text-sm font-semibold text-gray-500 dark:text-gray-300 title-case tracking-wider'>{display_name}</th>"
                            )
                        html_parts_list.append("</tr></thead>")
                        html_parts_list.append("<tbody class='bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700'>")
                        ...
                        for record in all_metrics_records:
                            html_parts_list.append("<tr class='hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-150 ease-in-out'>")
                            for col_key_record in cols_to_display_map_metrics.keys():
                                cell_value = record.get(col_key_record)
                                display_value_html: str
                                if col_key_record == 'metric_value' and (isinstance(cell_value, dict) or isinstance(cell_value, list)):
                                    display_value_html = _format_complex_value_to_html(cell_value)
                                else:
                                    display_value_html = str(cell_value) if pd.notna(cell_value) else "N/A"

                                td_class_list = [f"col-{col_key_record.lower().replace('_', '-')}", "px-2 py-1.5", "text-xs", "text-gray-700 dark:text-gray-300", "align-top"]
                                ...
                                html_parts_list.append(f"<td class='{' '.join(td_class_list)}'>{display_value_html}</td>")
                            html_parts_list.append("</tr>")
    ...
    async def generate_report(
        ...
        previous_period_metrics: Optional[Dict[str, Any]] = None
        if metrics_service:
            logger.debug(f"Fetching metrics for the period prior to {start_date.strftime('%Y-%m-%d')}")
            previous_period_metrics = await self._fetch_previous_period_metrics(
                current_start_date=start_date,
                metrics_service=metrics_service
            )
            if previous_period_metrics:
                logger.debug(f"Successfully fetched {len(previous_period_metrics)} metrics from the previous period.")
            else:
                logger.warning("No previous period metrics found or an error occurred while fetching.")
        else:
            logger.warning("Metrics service not provided. Skipping fetch of previous period metrics.")
        ...
        calculated_metrics = self._calculate_all_metrics(df=main_df, previous_period_metrics=previous_period_metrics)
        top_cwe_spotlight_data_list = self._prepare_data_for_top_cwe_spotlight_cards(main_df, top_n=4)
        ...
        formatted_metrics_for_cards = self._format_metrics_for_report_cards(calculated_metrics)
        ...
        for section_key, section_config in self.REPORT_STRUCTURE.get("looped_sections", {}).items():
            ...
            for chart_def in section_config.get("charts", []):
                ...
                figure = self._generate_plotly_figure(chart_data, chart_id, chart_title_override=chart_def.get("title"))
                ...
                if figure:
                    ...
                    if json_path:
                        ...
                        if insight_prompt_template and self.llm:
                            ...
                            logger.info(f"\nBuilding LLM prompt for chart insight:\ntemplate {insight_prompt_template}\n data context {prompt_context_data}\n\n")
                            ...
                            insight_html = markdown.markdown(insight, extensions=['fenced_code', 'tables', 'attr_list'])
                            llm_section_content[section_key][f"chart_insight_{chart_id}"] = insight_html
                            section_chart_insights[chart_id] = insight_html  # Store for use in narrative/summary prompts
                        elif not self.llm:
            ...
            if not self.llm:
                ...
                for i in range(1, 4):
                    ...
                    if callout_prompt_template:
                        ...
                        logger.info(f"\nBuilding LLM prompt for callout:\ntemplate {callout_prompt_template}\ndata context {prompt_context_data}\n\n")
                        ...
                        callout_html = markdown.markdown(callout_text, extensions=['fenced_code', 'tables', 'attr_list'])
                        section_callouts[callout_key] = callout_html  # Store for use in narrative/summary prompts
                ...
                if stats_definitions:
                    for stat_def in stats_definitions:
                        ...
                        if metric_id:
                            current_section_stats_for_prompt[metric_id] = calculated_metrics.get(metric_id)
                            # Add QoQ metrics automatically as discussed
                            for qoq_suffix in ["_qoq_delta_abs", "_qoq_delta_pct", "_qoq_comparison_str"]:
                                qoq_metric_id = f"{metric_id}{qoq_suffix}"
                                if qoq_metric_id in calculated_metrics:
                                    current_section_stats_for_prompt[qoq_metric_id] = calculated_metrics[qoq_metric_id]
                ...
                if narrative_prompt_template:
                    prompt_context_data = {
                        **base_llm_context_from_python,
                        ...
                        "data_context_payload": {
                            ...
                            "charts_data_summaries_in_section": {cid: all_chart_data_for_llm.get(cid, "N/A") for cid in section_charts_context},
                            "section_specific_stats": current_section_stats_for_prompt
                        }
                    }
                    ...
                    llm_section_content[section_key]["narrative"] = markdown.markdown(llm_markdown_narrative, extensions=['fenced_code', 'tables', 'attr_list'])
                else:
                ...
                if summary_prompt_template:
                    ...
                    llm_section_content[section_key]["summary"] = markdown.markdown(llm_markdown_summary, extensions=['fenced_code', 'tables', 'attr_list'])
                else:
        ...
        appendix_tables_context = self._generate_appendix_tables(main_df, appendix_tables_defs, calculated_metrics)
        ...
        if self.llm:
            ...
            analytical_section_keys = self.REPORT_STRUCTURE.get("looped_sections", {}).keys()
            ...
            for section_key, section_config in self.REPORT_STRUCTURE.get("explicit_sections", {}).items():
                ...
                if not section_prompts:
                    logger.debug(f"Skipping LLM generation for explicit section '{section_key}': No prompts defined.")
                    continue
                ...
                prompt_template = section_prompts.get(section_key) or section_prompts.get("narrative")

                if prompt_template:
                    logger.info(f"Preparing LLM context for explicit section: {section_key}")
                    ...
                    if section_key == "executive_summary":
                        ...
                        overall_stats_for_llm = {
                            ...
                            "critical_cves_count": calculated_metrics.get("critical_count"),
                            "important_cves_count": calculated_metrics.get("important_count"),
                            "critical_high_percentage": calculated_metrics.get("critical_high_pct"),
                            "cve_category_distribution_raw_counts": calculated_metrics.get("cve_category_distribution_raw_counts"),
                            "rce_pct": calculated_metrics.get("rce_pct"),
                            "eop_pct": calculated_metrics.get("eop_pct"),
                            "median_cvss_overall": calculated_metrics.get("median_cvss"),
                            "exploited_percentage": calculated_metrics.get("exploited_pct_kev"),  # Using KEV %
                            "median_days_to_patch": calculated_metrics.get("median_days_to_patch"),
                            "worst_case_cves_count": calculated_metrics.get("worst_case_cves"),
                            "top_impact_type": calculated_metrics.get("top_impact_type"),
                        }
                        overall_stats_for_llm = {k: v for k, v in overall_stats_for_llm.items() if v is not None}
                        ...
                        for other_section_key, other_section_data in llm_section_content.items():
                            if other_section_key in analytical_section_keys:
                                narrative_html = other_section_data.get('narrative')
                                summary_html = other_section_data.get('summary')
                                ...
                                if narrative_html:
                                    narrative_paragraphs = get_paragraphs_from_html(narrative_html)
                                    if narrative_paragraphs:
                                        # Add "Narrative:" marker
                                        combined_text_for_section += "Key points from section narrative:\n"
                                        # Take all but the last paragraph of the narrative
                                        pars_to_take = narrative_paragraphs[:-1] if len(narrative_paragraphs) > 1 else narrative_paragraphs
                                        for i, p_html in enumerate(pars_to_take):
                                            # text_to_add = p_html # If passing HTML directly
                                            # Or strip tags for cleaner text for LLM (LLM will re-markdown)
                                            text_to_add = BeautifulSoup(p_html, "html.parser").get_text(separator=" ", strip=True)

                                            # Check budget (character-based example)
                                            if current_chars + len(text_to_add) < MAX_TOKENS_PER_SECTION_CONTEXT:
                                                combined_text_for_section += text_to_add + "\n"  # Add newline for LLM readability
                                                current_chars += len(text_to_add)
                                            else:
                                                # Add truncated part if possible
                                                remaining_chars = MAX_TOKENS_PER_SECTION_CONTEXT - current_chars
                                                if remaining_chars > 20:  # Only add if meaningful amount
                                                    combined_text_for_section += text_to_add[:remaining_chars] + "...\n"
                                ...
                                if summary_html and current_chars < MAX_TOKENS_PER_SECTION_CONTEXT:
                                    summary_paragraphs = get_paragraphs_from_html(summary_html)
                                    if summary_paragraphs:
                                        # Add "Summary:" marker if narrative was also added, or as main header
                                        if narrative_html and narrative_paragraphs:  # Check if narrative part was added
                                            combined_text_for_section += "Key points from section summary:\n"
                                        else:  # No narrative, summary is primary
                                            combined_text_for_section += "Section summary:\n"

                                        for i, p_html in enumerate(summary_paragraphs):
                                            # text_to_add = p_html # If passing HTML directly
                                            text_to_add = BeautifulSoup(p_html, "html.parser").get_text(separator=" ", strip=True)

                                            if current_chars + len(text_to_add) < MAX_CHARS_PER_SECTION_CONTEXT:
                                                combined_text_for_section += text_to_add + "\n"
                                                current_chars += len(text_to_add)
                                            else:
                                                remaining_chars = MAX_CHARS_PER_SECTION_CONTEXT - current_chars
                                                if remaining_chars > 20:
                                                    combined_text_for_section += text_to_add[:remaining_chars] + "...\n"
                                                break  # Stop adding from summary

                                if combined_text_for_section.strip():
                                    section_texts_for_exec_summary_prompt[other_section_key] = combined_text_for_section.strip()

                        # 3. Set the specific payload for the Exec Summary prompt
                        data_payload_for_llm = {
                            "overall_report_stats_for_llm": overall_stats_for_llm,
                            "section_main_texts": section_texts_for_exec_summary_prompt,
                        }
                        # Define model parameters specifically for Exec Summary
                        model_key = section_key  # Use 'executive_summary'
                        llm_model = self.LLM_TASK_MODELS.get(model_key, self.LLM_TASK_MODELS.get("narrative"))  # Fallback
                        max_tokens = 1500  # More tokens for exec summary usually
                        ...
                        overall_stats_for_llm_conclusion = {
                            ...
                            "critical_high_percentage": calculated_metrics.get("critical_high_pct"),
                            "median_cvss_overall": calculated_metrics.get("median_cvss"),
                            "exploited_percentage": calculated_metrics.get("exploited_pct_kev"),
                            "median_days_to_patch": calculated_metrics.get("median_days_to_patch"),
                            "worst_case_cves_count": calculated_metrics.get("worst_case_cves"),
                            "top_impact_type": calculated_metrics.get("top_impact_type"),
                            "cve_category_distribution_raw_counts": calculated_metrics.get("cve_category_distribution_raw_counts"),
                        }
                        overall_stats_for_llm_conclusion = {k: v for k, v in overall_stats_for_llm_conclusion.items() if v is not None}
                        ...
                        executive_summary_text = llm_section_content.get("executive_summary", {}).get("narrative", "Executive Summary not available.")

                        section_summaries = {}
                        for other_section_key, other_section_data in llm_section_content.items():
                            if other_section_key in analytical_section_keys:
                                summary_text = other_section_data.get('summary')
                                if summary_text:
                                    section_summaries[other_section_key] = summary_text  # Pass the raw summary text (Markdown?)

                        # 3. Set the specific payload for the Conclusion prompt
                        data_payload_for_llm = {
                            "overall_report_stats_for_llm": overall_stats_for_llm_conclusion,
                            "executive_summary_text": executive_summary_text,  # Pass the generated summary text/HTML
                            "section_summaries": section_summaries,  # Pass summaries from analytical sections
                        }
                        # Define model parameters specifically for Conclusion
                        model_key = section_key  # Use 'report_conclusion'
                        llm_model = self.LLM_TASK_MODELS.get(model_key, self.LLM_TASK_MODELS.get("narrative"))
                        max_tokens = 1000  # Adjust as needed for conclusion length
                        ...
                        logger.warning(f"Using default context for explicit section '{section_key}'. Consider tailoring.")
                        data_payload_for_llm = {
                            "overall_report_stats": calculated_metrics,  # Passes everything
                            "all_section_content": llm_section_content,  # Passes everything generated so far
                        }
                        # Default model parameters
                        model_key = section_key if section_key in self.LLM_TASK_MODELS else "narrative"
                    ...
                    prompt_context_data = {
                        **base_llm_context_from_python,  # Includes dates, title etc.
                        "section_title": section_config.get('heading', section_key.replace('_', ' ').title()),
                        # Add section_key itself to the payload if prompts need it internally
                        "data_context_payload": {
                            "section_key": section_key,  # Make section_key available inside payload
                            **data_payload_for_llm  # Add the specific payload determined above
                        }
                    }

                    # --- Call LLM ---
                    logger.info(f"Generating content for explicit section: {section_key} using model {llm_model}")
                    logger.info(f"\nBuilding LLM prompt for explicit section:\ntemplate {prompt_template}\ndata context {prompt_context_data}\n\n")
                    ...
                    if narrative_markdown:
                        ...
                        narrative_html = markdown.markdown(narrative_markdown, extensions=['fenced_code', 'tables', 'attr_list'])
                        # Store the HTML in the results dictionary
                        llm_section_content[section_key]["narrative"] = narrative_html
                        logger.info(f"Successfully generated and stored HTML content for {section_key}")
                    else:
                        logger.warning(f"LLM returned empty content for {section_key}")
                        llm_section_content[section_key]["narrative"] = f"<p>Content generation failed for {section_key}.</p>"

                else:
                    # Create placeholder if no prompt template was found for this section
                    logger.debug(f"Skipping LLM generation for explicit section '{section_key}': No primary prompt template found.")
                    # Check if content already exists (e.g., from a previous run or default)
                    if "narrative" not in llm_section_content.get(section_key, {}):
                        llm_section_content[section_key]["narrative"] = f"<p>Narrative not generated for {section_key} (no prompt template defined).</p>"
        ...
        try:
            ...
            logger.debug(f"Template path: {type(template_relative_path)} {template_relative_path}")
        ...
        summary_file_path = DATA_DIR / "llm_usage" / "quarterly_deep_dive" / f"llm_usage_summary_{end_date.strftime('%Y-%m-%d')}.txt"
        try:
        ...
        if metrics_service:
            ...
            time_details_for_db = {
                "start_date": start_date,
                "end_date": end_date,
                "label": f"Q{(start_date.month - 1) // 3 + 1} {start_date.year} - {config.report_title}"
            }
            try:
                logger.debug(f"Attempting to save calculated metrics for period {period_key} using report name '{config.report_title}'.")
                ...
                logger.debug(f"Successfully initiated saving of metrics for period {period_key}.")
            except Exception as e:
                logger.error(f"Error occurred while calling _save_all_metrics for period {period_key}: {e}", exc_info=True)
                # Decide if this error should halt report generation or just be logged.
                # For now, it's logged, and report generation continues.
        else:
            logger.warning("Metrics service not provided to generate_report. Skipping saving metrics.")
        # --- 14. Finish ---
    ...
    def _standardize_windows_product_name(self, product_string: str | None) -> str:
        ...
        if "amd64" in name: name = name.replace("amd64", "x64")
        ...
        if parts:
            # Capitalize "Windows"
            if parts[0].lower() == "windows" and len(parts) > 1: # Avoid capitalizing if it's just "windows"
                parts[0] = "Windows"
            # Capitalize version identifiers like 22H2
            for i, part in enumerate(parts):
                if len(part) > 1 and "h" in part and part[:-1].isdigit(): # e.g. 21h2, 22H2
                    parts[i] = part.upper()
            name = " ".join(parts)
    ...
    def get_llm_token_usage_report_data(self) -> Dict[str, Any]:
        ...
        if not self.llm_token_usage_log:
            empty_summary_text = "No LLM calls were made or logged during this report generation."
            logger.info(empty_summary_text)
            return {
                "summary_text": empty_summary_text,
                "total_calls": 0, "successful_calls": 0, "failed_calls": 0,
                "grand_total_input_tokens": 0, "grand_total_completion_tokens": 0,
                "grand_total_tokens_billed": 0, "grand_total_estimated_cost": 0.0,
        ...
        report_data = {
            ...
            "usage_by_model": defaultdict(lambda: {
                "calls": 0, "success": 0, "input_tokens": 0,
                "completion_tokens": 0, "total_billed_tokens": 0, "cost": 0.0
            }),
        ...
        for log_entry in self.llm_token_usage_log:
            ...
            input_tokens_for_cost = log_entry.get("final_input_tokens_for_cost", 0)
            completion_tokens_for_cost = log_entry.get("final_completion_tokens_for_cost", 0)
            current_cost = log_entry.get("cost_estimate", 0.0)

            report_data["grand_total_input_tokens"] += input_tokens_for_cost
            report_data["grand_total_completion_tokens"] += completion_tokens_for_cost
            report_data["grand_total_estimated_cost"] += current_cost

            # By model
            model_stats = report_data["usage_by_model"][log_entry["model_name"]]
            model_stats["calls"] += 1
            if is_success: model_stats["success"] +=1
            model_stats["input_tokens"] += input_tokens_for_cost
            model_stats["completion_tokens"] += completion_tokens_for_cost
            model_stats["total_billed_tokens"] += (input_tokens_for_cost + completion_tokens_for_cost)
            model_stats["cost"] += current_cost

            # By task
            task_stats = report_data["usage_by_task"][log_entry.get("task_type", "unknown_task")]
            task_stats["calls"] += 1
            if is_success: task_stats["success"] +=1
            task_stats["input_tokens"] += input_tokens_for_cost
            task_stats["completion_tokens"] += completion_tokens_for_cost
            task_stats["total_billed_tokens"] += (input_tokens_for_cost + completion_tokens_for_cost)
            task_stats["cost"] += current_cost

        report_data["grand_total_tokens_billed"] = report_data["grand_total_input_tokens"] + report_data["grand_total_completion_tokens"]

        # Format cost to a reasonable number of decimal places
        report_data["grand_total_estimated_cost"] = round(report_data["grand_total_estimated_cost"], 6)
        for model_name in report_data["usage_by_model"]:
            report_data["usage_by_model"][model_name]["cost"] = round(report_data["usage_by_model"][model_name]["cost"], 6)
        for task_name in report_data["usage_by_task"]:
            report_data["usage_by_task"][task_name]["cost"] = round(report_data["usage_by_task"][task_name]["cost"], 6)
        ...
        summary_lines = [
            ...
            "===========================================",
            f"Total LLM Calls: {report_data['total_calls']} (Successful: {report_data['successful_calls']}, Failed: {report_data['failed_calls']})",
            "--- Overall Totals ---",
            f"  Total Input Tokens (billed):     {report_data['grand_total_input_tokens']:,}",
            f"  Total Completion Tokens (billed):{report_data['grand_total_completion_tokens']:,}",
            f"  Grand Total Tokens (billed):     {report_data['grand_total_tokens_billed']:,}",
            f"  Grand Total Estimated Cost:      ${report_data['grand_total_estimated_cost']:.6f}",
            "\n--- Usage by Model ---"
        ]
        for model, data in sorted(report_data["usage_by_model"].items()): # Sort for consistent output
            summary_lines.append(
                f"  Model: {model}\n"
                f"    Calls: {data['calls']} (Success: {data['success']})\n"
                f"    Input Tokens: {data['input_tokens']:,}, Completion Tokens: {data['completion_tokens']:,}, Total Billed: {data['total_billed_tokens']:,}\n"
                f"    Est. Cost: ${data['cost']:.6f}"
            )

        summary_lines.append("\n--- Usage by Task Type ---")
        for task, data in sorted(report_data["usage_by_task"].items()): # Sort for consistent output
            summary_lines.append(
                f"  Task: {task}\n"
                f"    Calls: {data['calls']} (Success: {data['success']})\n"
                f"    Input Tokens: {data['input_tokens']:,}, Completion Tokens: {data['completion_tokens']:,}, Total Billed: {data['total_billed_tokens']:,}\n"
        ...
        for i, entry in enumerate(self.llm_token_usage_log):
            summary_lines.append(
                f"  Call {i+1}: [{entry['timestamp'].strftime('%Y-%m-%d %H:%M:%S')}] Task: {entry.get('task_type', 'N/A')}, "
                f"Model: {entry['model_name']}, Status: {entry['status']}, "
                f"In(calc): {entry.get('total_input_tokens_calculated',0):,}, "
                f"Out(api): {entry.get('final_completion_tokens_for_cost',0):,}, " # Changed from completion_tokens_api to final_...
                f"Cost: ${entry.get('cost_estimate', 0.0):.6f}"
            )

        report_data["summary_text"] = "\n".join(summary_lines)
        report_data["detailed_log"] = self.llm_token_usage_log # Keep the original structured log too
...
def generate_synthetic_cve_data(
    ...
    cve_categories = [
        "remote_code_execution", "privilege_elevation", "denial_of_service",
        "disclosure", "spoofing", "tampering", "feature_bypass",
        "nc"
    ]
    ...
    candidate_builds_pool = {
        "Windows 10 21H2": [
            "10.0.1.19044", "10.0.1.19052", "10.0.1.19060", "10.0.1.19068", "10.0.1.19076"
        ],
        "Windows 10 22H2": [
            "10.0.2.19045", "10.0.2.19053", "10.0.2.19061", "10.0.2.19069", "10.0.2.19077"
        ],
        "Windows 11 22H2": [
            "10.0.3.22621", "10.0.3.22634", "10.0.3.22647", "10.0.3.22659", "10.0.3.22672"
        ],
        "Windows 11 23H2": [
            "10.0.4.22631", "10.0.4.22644", "10.0.4.22657", "10.0.4.22669", "10.0.4.22682"
        ],
        "Windows 11 24H2": [
            "10.0.5.26100", "10.0.5.26118", "10.0.5.26136", "10.0.5.26154", "10.0.5.26172"
        ]
    }
    outlier_counts = {
        "Critical_low_end": 0,
    ...
    num_worst_case = max(1, min(int(num_records / 100) * 2, int(num_records * 0.02)))
    logger.info(f"Will include {num_worst_case} worst-case CVEs in the dataset")

    # --- Flatten CWE IDs for random selection (once at the start) ---
    all_cwe_ids = [cwe_id for category_data in CWE_ROOT_CAUSE.values() for cwe_id in category_data.get("ids", [])]
    if not all_cwe_ids:
        logger.warning("No CWE IDs found in CWE_ROOT_CAUSE. Synthetic CWE data will be empty.")
        all_cwe_ids = ["CWE-0"]  # Add a placeholder to prevent errors if empty

    # --- Prepare build number lists (once at the start) ---
    win10_builds = []
    win11_builds = []
    if 'candidate_builds_pool' in locals() or 'candidate_builds_pool' in globals():
        ...
        logger.warning("'candidate_builds_pool' not found. Build number generation will use placeholders.")
    ...
    for i in range(num_records):
        ...
        strategies = []
        if win10_builds: strategies.append('win10_only')  # noqa E701
        if win11_builds: strategies.append('win11_only')  # noqa E701
        if win10_builds and win11_builds: strategies.append('mixed')  # noqa E701
        ...
        if chosen_strategy == 'win10_only':
            builds_for_cve = list(np.random.choice(win10_builds, size=min(num_builds, len(win10_builds)), replace=False))
        elif chosen_strategy == 'win11_only':
            builds_for_cve = list(np.random.choice(win11_builds, size=min(num_builds, len(win11_builds)), replace=False))
        elif chosen_strategy == 'mixed':
            combined_pool = list(set(win10_builds + win11_builds))
            if combined_pool:
                builds_for_cve = list(np.random.choice(combined_pool, size=min(num_builds, len(combined_pool)), replace=False))
        ...
        if current_selected_count < num_builds:
            ...
            combined_options = list(set(win10_builds + win11_builds) - set(builds_for_cve))
            if combined_options:
                builds_for_cve.extend(list(np.random.choice(combined_options, size=min(needed_additional, len(combined_options)), replace=False)))

        current_selected_count = len(builds_for_cve)
        if current_selected_count < num_builds:
            needed_at_end = num_builds - current_selected_count
            all_candidate_builds_flat = [item for sublist in candidate_builds_pool.values() for item in sublist]
            if all_candidate_builds_flat:
                unique_from_all_candidates = list(set(all_candidate_builds_flat) - set(builds_for_cve))
                if unique_from_all_candidates:
                    builds_for_cve.extend(list(np.random.choice(unique_from_all_candidates, size=min(needed_at_end, len(unique_from_all_candidates)), replace=False)))
                if len(builds_for_cve) < num_builds:
                    needed_with_repeats = num_builds - len(builds_for_cve)
                    builds_for_cve.extend(list(np.random.choice(all_candidate_builds_flat, size=needed_with_repeats, replace=True)))

        if not builds_for_cve:  # Final placeholder if all else failed
            builds_for_cve = [f"placeholder_build_{j+1}.{fake.msisdn()[-4:]}" for j in range(num_builds)]
        ...
        if final_fill_needed > 0:
            all_available_options = list(set(win10_builds + win11_builds) - set(metadata['build_numbers']))
            if all_available_options:
                metadata['build_numbers'].extend(list(np.random.choice(all_available_options, size=min(final_fill_needed, len(all_available_options)), replace=False)))
        ...
        metadata['id'] = record['id_']  # Also store in metadata for potential flattening later
        metadata['post_id'] = f"CVE-{np.random.randint(2023, end_date.year + 1)}-{np.random.randint(10000, 99999)}"
        metadata['published'] = fake.date_time_between(start_date=start_date, end_date=end_date, tzinfo=None).replace(tzinfo=None)
        metadata['revision'] = np.random.choice(["1.000", "1.100", "2.000"], p=[0.85, 0.10, 0.05])
        metadata['severity_type'] = np.random.choice(severities, p=[0.05, 0.65, 0.25, 0.05])
        metadata['cve_category'] = np.random.choice(cve_categories, p=[0.20, 0.28, 0.15, 0.10, 0.12, 0.05, 0.05, 0.05])
        metadata['impact_type'] = metadata['cve_category'].replace('_', ' ').title()
        metadata['title'] = f"{fake_title_base.capitalize()} ({metadata['post_id']})"
        ...
        metadata['post_type'] = np.random.choice(post_types, p=[0.02, 0.55, 0.43])
        metadata['products'] = fake.random_elements(elements=products_list, length=np.random.randint(1, 4), unique=True)
        metadata['nvd_published_date'] = metadata['published'] + timedelta(days=np.random.randint(1, 4))
        ...
        if cwe_details:
            ...
            metadata['cwe_url'] = cwe_details.get('cwe_url', f"https://cwe.mitre.org/data/definitions/{selected_cwe_id.split('-')[-1]}.html")
            metadata['cwe_description'] = cwe_details.get('description', '')
        else:
            metadata['cwe_name'] = selected_cwe_id
            metadata['cwe_url'] = f"https://cwe.mitre.org/data/definitions/{selected_cwe_id.split('-')[-1]}.html"
        ...
        if current_severity_type == 'critical':
            if outlier_counts["Critical_low_end"] < TARGET_OUTLIERS_PER_TYPE_DIRECTION:
            ...
            if outlier_counts["Important_low"] < TARGET_OUTLIERS_PER_TYPE_DIRECTION:
                score = 7.0  # Force a score at the low end of Important
                outlier_counts["Important_low"] += 1
            elif outlier_counts["Important_high"] < TARGET_OUTLIERS_PER_TYPE_DIRECTION:
            ...
            if outlier_counts["Moderate_low"] < TARGET_OUTLIERS_PER_TYPE_DIRECTION:
                score = 3.777  # Force a score at the low end of Moderate
                outlier_counts["Moderate_low"] += 1
            elif outlier_counts["Moderate_high"] < TARGET_OUTLIERS_PER_TYPE_DIRECTION:
            ...
            if outlier_counts["Low_high_end"] < TARGET_OUTLIERS_PER_TYPE_DIRECTION:
        ...
        if score is None:
            ...
            logger.warning(f"Unexpected severity_type '{current_severity_type}', assigning random score.")
        ...
        if is_worst_case:
            ...
            local_confidentiality_impact = np.random.choice(["High", "Low", "None"])
            local_integrity_impact = np.random.choice(["High", "Low", "None"])
            local_availability_impact = np.random.choice(["High", "Low", "None"])
        ...
        local_base_score_str = f"{local_base_score_num} {local_base_score_rating}"
        ...
        nist_cvss_base_field_names = [
            'base_score', 'base_score_num', 'base_score_rating', 'vector',
            'attack_vector', 'attack_complexity', 'privileges_required',
            'user_interaction', 'scope', 'confidentiality', 'integrity',
            'availability', 'exploitability_score', 'impact_score'
        ]
        ...
        current_record = {
            ...
            "kb_ids": [],  # Remains empty for synthetic data as per current logic
            "metadata": metadata,  # The now correctly structured metadata dictionary
        }
...
def get_paragraphs_from_html(html_text: str) -> list[str]:
    ...
    raw_paragraphs = re.split(r'\n\s*\n', html_text.strip()) # Split by blank lines
