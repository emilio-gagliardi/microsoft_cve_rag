CWE_ROOT_CAUSE = {
    ...
    "memory_safety": {
        ...
        "description": (
            "These vulnerabilities relate to how software manages computer"
            " memory. Attackers exploit these flaws to read sensitive data,"
            " crash systems, or execute malicious code by manipulating memory"
            " locations they shouldn't access. Proper memory handling and"
            " boundary checks are crucial defenses."
        ),
    },
    ...
    "race_concurrency": {
        ...
        "description": (
            "Concurrency issues arise when multiple processes access shared"
            " resources without proper coordination. This can lead to"
            " unpredictable behavior, data corruption, or deadlocks, known as"
            " race conditions. Ensuring proper locking and synchronization"
            " mechanisms prevents these system stability problems."
        ),
    },
    ...
    "improper_access_control": {
        ...
        "description": (
            "Access control flaws occur when software fails to correctly"
            " enforce permissions, allowing unauthorized users to view data or"
            " perform actions. Privilege escalation means an attacker gains"
            " higher-level access than intended. Robust permission checks and"
            " principle of least privilege are key mitigations."
        ),
    },
    ...
    "input_validation_injection": {
        ...
        "description": (
            "These weaknesses happen when software doesn't properly sanitize"
            " or validate user-supplied input. Attackers can inject malicious"
            " commands (like SQL injection) or scripts (like cross-site"
            " scripting - XSS) to steal data or compromise the system. Strict"
            " input validation is essential to block such attacks."
        ),
    },
    ...
    "cryptographic_issues": {
        ...
        "description": (
            "Cryptographic flaws involve weak encryption algorithms, improper"
            " key management, or predictable random number generation. These"
            " issues can expose sensitive data like passwords or session"
            " tokens. Using strong, standard cryptographic practices is vital"
    ...
    "configuration_weakness": {
        ...
        "description": (
            "Vulnerabilities can arise from insecure default settings,"
            " incorrect configurations, or inadequate system hardening. This"
            " includes overly permissive file permissions or unnecessary"
            " services being enabled. Regularly reviewing configurations and"
            " applying security baselines reduces this risk."
        ),
    },
    ...
    "logic_state_errors": {
        ...
        "description": (
            "Logic flaws occur when the application's intended workflow or"
            " state management can be manipulated in unexpected ways. This"
            " might allow bypassing security checks, performing unauthorized"
            " actions, or causing denial of service. Thorough testing of"
            " application logic helps identify these issues."
        ),
    },
}
...
CWE_DETAILS = {
    ...
    "CWE-74": {
        ...
        "description": (
            "The product constructs all or part of a command, data structure,"
            " or record using externally-influenced input from an upstream"
            " component, but it does not neutralize or incorrectly neutralizes"
    ...
    "CWE-94": {
        ...
        "description": (
            "The product generates code using externally-influenced input from"
            " an upstream component, but it does not neutralize or incorrectly"
            " neutralizes special elements that could modify the intended code"
    ...
    "CWE-119": {
        ...
        "description": (
            "The product does not properly restrict or validate operations"
            " within the bounds of a memory buffer, allowing an attacker to"
            " access or modify memory outside of the intended bounds."
        ),
    ...
    "CWE-120": {
        ...
        "description": (
            "The product copies data into a buffer without checking if the"
            " input size exceeds the buffer's capacity, leading to an"
            " overflow."
        ),
        "category": "Memory-Safety",
    ...
    "CWE-188": {
        ...
        "description": (
            "The product relies on the memory layout of a type to perform"
            " operations, but this layout is not guaranteed to be consistent"
            " across different platforms or versions."
        ),
        "category": "Memory-Safety",
    ...
    "CWE-284": {
        ...
        "description": (
            "The product does not enforce proper access control, allowing"
    ...
    "CWE-285": {
        ...
        "description": (
            "The product does not enforce proper authorization checks,"
            " allowing unauthorized access to resources or operations."
        ),
        "category": "Access-Control & Priv-Escalation Logic",
    ...
    "CWE-310": {
        ...
        "description": (
            "The product uses weak or inadequate encryption algorithms,"
            " leading to vulnerabilities in data confidentiality or integrity."
        ),
    ...
    "CWE-337": {
        ...
        "description": (
            "The product uses a predictable seed value for a pseudo-random"
            " number generator (PRNG), leading to vulnerabilities in data"
    ...
    "CWE-338": {
        ...
        "description": (
            "The product uses a cryptographically weak pseudo-random number"
            " generator (PRNG), leading to vulnerabilities in data"
            " confidentiality or integrity."
        ),
        "category": "Cryptography & Confidentiality Flaws",
    ...
    "CWE-362": {
        ...
        "description": (
            "The product uses concurrent execution using shared resources"
            " without proper synchronization, leading to vulnerabilities in"
    ...
    "CWE-416": {
        "name": "Use After Free",
        "description": (
            "The product uses a use-after-free vulnerability, leading to"
            " vulnerabilities in data confidentiality or integrity."
        ),
        "category": "Memory-Safety",
    ...
    "CWE-762": {
        ...
        "description": (
            "The product uses mismatched memory management routines, leading"
            " to vulnerabilities in data confidentiality or integrity."
        ),
        "category": "Memory-Safety",
    ...
    "CWE-783": {
        ...
        "description": (
            "The product uses operator precedence logic error, leading to"
            " vulnerabilities in data confidentiality or integrity."
        ),
        "category": "Concurrency / Synchronisation",
    ...
    "CWE-787": {
        ...
        "description": (
            "The product uses out-of-bounds write, leading to vulnerabilities"
            " in data confidentiality or integrity."
        ),
        "category": "Memory-Safety",
    ...
    "CWE-840": {
        ...
        "description": (
            "The product uses business logic errors, leading to"
            " vulnerabilities in data confidentiality or integrity."
        ),
        "category": "Business / Application Logic",
    ...
    "CWE-841": {
        ...
        "description": (
            "The product uses improper enforcement of behavioral workflow,"
            " leading to vulnerabilities in data confidentiality or integrity."
        ),
        "category": "Business / Application Logic",
    ...
    "CWE-642": {
        ...
        "description": (
            "The product uses external control of critical state data, leading"
            " to vulnerabilities in data confidentiality or integrity."
        ),
        "category": "Business / Application Logic",
