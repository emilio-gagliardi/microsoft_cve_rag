...
class EmbeddingService:
    def __init__(self):
        self.model_name = DEFAULT_EMBEDDING_CONFIG.model_name
        self.embedding_length = DEFAULT_EMBEDDING_CONFIG.embedding_length
        self.model_card = DEFAULT_EMBEDDING_CONFIG.model_card
